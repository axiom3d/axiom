...
*/
		var height = document.body.offsetHeight - this.nonScrollingRegion.offsetHeight - 4;
		...
		// this.scrollingRegion.style.width = document.body.clientWidth-32;
		// this.scrollingRegion.style.width = "100.1%";
	}
