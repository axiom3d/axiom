...
namespace RenderSystem_OpenGL
{
	...
	public class GLHardwareIndexBuffer : HardwareIndexBuffer
	{
		...
		protected override IntPtr LockImpl(int offset, int length, BufferLocking locking)
		{
			...
			{
				// bind this buffer
				ext.glBindBufferARB(OpenGLExtensions.GL_ELEMENT_ARRAY_BUFFER_ARB, bufferID);

				if(locking == BufferLocking.Discard)
				{
					ext.glBufferDataARB(OpenGLExtensions.GL_ELEMENT_ARRAY_BUFFER_ARB,
						(uint)sizeInBytes,
						null,
						GLHelper.ConvertEnum(usage));
				...
				IntPtr ptr = ext.glMapBufferARB(OpenGLExtensions.GL_ELEMENT_ARRAY_BUFFER_ARB, access);
		...
		public override void UnlockImpl()
		{
			...
			ext.glUnmapBufferARB(OpenGLExtensions.GL_ELEMENT_ARRAY_BUFFER_ARB);
		...
		public override void WriteData(int offset, int length, IntPtr src, bool discardWholeBuffer)
		{
			...
			unsafe
			{
				...
				ext.glBufferSubDataARB(
					OpenGLExtensions.GL_ELEMENT_ARRAY_BUFFER_ARB, 
					(uint)offset, 
					(uint)length, 
					src.ToPointer());
			}
