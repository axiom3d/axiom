...
namespace Axiom.Overlays.Elements {
    ...
    public class BorderPanel : Panel {
        ...
        public static void ParserLeftBorderUV(string[] parms, params object[] objects) {
            ...
            float u1 = float.Parse(parms[0]);
            float v1 = float.Parse(parms[1]);
            float u2 = float.Parse(parms[2]);
            float v2 = float.Parse(parms[3]);
        ...
        public static void ParserBorderSize(string[] parms, params object[] objects) {
            ...
            float left = float.Parse(parms[0]);
            float right = float.Parse(parms[1]);
            float top = float.Parse(parms[2]);
            float bottom = float.Parse(parms[3]);
