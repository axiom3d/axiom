...
namespace Axiom.Samples.VolumeTexture
{
	...
	public class ThingRendable : SimpleRenderable
	{
		...
		protected void Initialize()
		{
			...
			vertexBuffer = HardwareBufferManager.Instance.CreateVertexBuffer( decl.Clone( 0 ), nVertices,
			                                                                  BufferUsage.DynamicWriteOnly );

			bind.SetBinding( 0, vertexBuffer );

			HardwareIndexBuffer indexBuffer = HardwareBufferManager.Instance.CreateIndexBuffer( IndexType.Size16, count*6,
