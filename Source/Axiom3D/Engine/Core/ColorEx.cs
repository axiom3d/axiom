...
{
    /// <summary>
    ///		This class is necessary so we can store the color components as Realing 
    ...
    public class ColorEx : IComparable
    {
        ...
        ///		Default constructor.
        /// </summary>
        public ColorEx( Real r, Real g, Real b ) : this( 1.0f, r, g, b )
        {
        }
        ...
        ///		Default constructor.
        /// </summary>
        public ColorEx( Real grayLevel ) : this( 1.0f, grayLevel, grayLevel, grayLevel )
        {
        }
        ...
        public ColorEx( Real a, Real r, Real g, Real b )
        {
            this.a = a;
            this.r = r;
            this.g = g;
        ...
        /// <summary>
        ///		Constructor taking an hex (HTML) value
        /// </summary>
        /// <param name="hexValue">Color value in the format 0xAARRGGBB.</param>
        public ColorEx( uint hexValue )
        {
        ...
        public static ColorEx Subtract( ColorEx left, ColorEx right )
        {
            return left - right;
        }


        public static ColorEx Subtract( ColorEx left, ColorEx right, bool subtractAlpha )
        {
            return new ColorEx(
                ( subtractAlpha ? ( left.a - right.a % 1f ) : left.a ),
                left.r - right.r % 1f,
                left.g - right.g % 1f,
                left.b - right.b % 1f );
        }
        ...
        public static ColorEx Add( ColorEx left, ColorEx right )
        {
            return left + right;
        }


        public static ColorEx Add( ColorEx left, ColorEx right, bool addAlpha )
        {
            return new ColorEx(
                ( addAlpha ? ( left.a + right.a % 1f ) : left.a ),
                left.r + right.r % 1f,
                left.g + right.g % 1f,
                left.b + right.b % 1f );
        }
        ...
        #region Adjusting
        public ColorEx AdjustIntensity( Real aIntensity, Real rIntensity, Real gIntensity, Real bIntensity )
        {
            return new ColorEx(
                a * aIntensity,
                r * rIntensity,
        ...
        public ColorEx AdjustIntensity( Real aIntensity, Real colorIntensity )
        {
            return AdjustIntensity( aIntensity, colorIntensity, colorIntensity, colorIntensity );
        }

        public ColorEx AdjustIntensity( Real colorIntensity )
        {
            return AdjustIntensity( 1f, colorIntensity );
        }


        public ColorEx Adjust( Color maxColorChange, Real colorChangeIntensity )
        {
            return Adjust( ColorEx.FromColor( maxColorChange ), colorChangeIntensity );
        }

        public ColorEx Adjust( ColorEx maxColorChange, Real colorChangeIntensity )
        {
            return Adjust( maxColorChange, 0f, colorChangeIntensity, colorChangeIntensity, colorChangeIntensity );
        }

        public ColorEx Adjust( ColorEx maxColorChange, Real aChangeIntensity, Real rChangeIntensity, Real gChangeIntensity, Real bChangeIntensity )
        {
            return Adjust( maxColorChange.a * aChangeIntensity, maxColorChange.r * rChangeIntensity, maxColorChange.g * gChangeIntensity, maxColorChange.b * bChangeIntensity );
        }


        public ColorEx Adjust( Color colorChange )
        {
            return Adjust( ColorEx.FromColor( colorChange ) );
        }
        public ColorEx Adjust( ColorEx colorChange )
        {
            return Adjust( colorChange.a, colorChange.r, colorChange.g, colorChange.b );
        }

        public ColorEx Adjust( Real rChange, Real gChange, Real bChange )
        {
            return Adjust( 0, rChange, gChange, bChange );
        }
        public ColorEx Adjust( Real aChange, Real rChange, Real gChange, Real bChange )
        {
            return new ColorEx(
                ( a + aChange ) % 1f,
                ( r + rChange ) % 1f,
        ...
        public static ColorEx Parse( string text )
        {
            Color knownColor = Color.FromName( text );
            if ( knownColor.IsKnownColor )
            {
                return ColorEx.FromColor( knownColor );
            }
            try
            {
                uint argbHex = uint.Parse( text, System.Globalization.NumberStyles.HexNumber );
                return new ColorEx( argbHex );
            }
            catch ( Exception e )
            {
            }

            throw new FormatException( "Color being parsed from string '{0}' that is neither a known color name nor hex ARGB value." );
        }

        /// <summary>
        /// Gets the color as an HTML style AARRGGBB hex number
        /// </summary>
        /// <returns></returns>
        public string ToHexString()
        {
            return this.ToARGB().ToString( "{0:x}" );
        }
        ...
        /// </remarks>
        /// <returns></returns>
        public void ToArrayRGBA( Real[] vals )
        {
            vals[ 0 ] = r;
            vals[ 1 ] = g;
            vals[ 2 ] = b;
        ...
        {
            return new ColorEx( (Real)color.A / 255.0f, (Real)color.R / 255.0f, (Real)color.G / 255.0f, (Real)color.B / 255.0f );
        }
        ...
        {
            return obj is ColorEx && this == (ColorEx)obj;
        }
