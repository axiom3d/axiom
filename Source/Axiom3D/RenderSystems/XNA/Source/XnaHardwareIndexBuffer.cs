...
namespace Axiom.RenderSystems.Xna
{
    class XnaHardwareIndexBuffer: HardwareIndexBuffer
    {
        ...
        protected XnaF.Graphics.IndexBuffer xnaBuffer;
        ...
        public XnaHardwareIndexBuffer( IndexType type, int numIndices, BufferUsage usage,
            XnaF.Graphics.GraphicsDevice device, bool useSystemMemory, bool useShadowBuffer )
            : base( type, numIndices, usage, useSystemMemory, useShadowBuffer )
        {

            XnaF.Graphics.IndexElementSize elementSize = ( type == IndexType.Size16 ? XnaF.Graphics.IndexElementSize.SixteenBits : XnaF.Graphics.IndexElementSize.ThirtyTwoBits);

            // create the buffer
            xnaBuffer = new XnaF.Graphics.IndexBuffer( device, sizeInBytes, XnaHelper.ConvertEnum( usage ), elementSize );
        }
        ...
        /// </summary>
        public XnaF.Graphics.IndexBuffer XnaIndexBuffer
        {
            get
            {
                return xnaBuffer;
