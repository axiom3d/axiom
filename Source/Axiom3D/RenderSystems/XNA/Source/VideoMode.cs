...
namespace Axiom.RenderSystems.Xna
{
    ...
    public class VideoMode
    {
        ...
        private XnaF.Graphics.DisplayMode displayMode;
        private int modeNum;
        ...
        {
            modeNum = ++modeCount;
            displayMode = new XnaF.Graphics.DisplayMode();
        }
        ...
        /// </summary>
        public VideoMode( XnaF.Graphics.DisplayMode videoMode )
        {
            modeNum = ++modeCount;
        ...
        /// </summary>
        public XnaF.Graphics.SurfaceFormat Format
        {
            get
            {
        ...
        public int ColorDepth
        {
            get
            {
                if ( displayMode.Format == XnaF.Graphics.SurfaceFormat.Bgr32 ||
                    displayMode.Format == XnaF.Graphics.SurfaceFormat.Color ||
                    displayMode.Format == XnaF.Graphics.SurfaceFormat.Bgr24 )
                {
                    return 32;
                }
                else
        ...
        /// </summary>
        public XnaF.Graphics.DisplayMode DisplayMode
        {
            get
            {
                return displayMode;
