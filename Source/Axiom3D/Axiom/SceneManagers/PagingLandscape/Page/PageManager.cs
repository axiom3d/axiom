...
namespace Axiom.SceneManagers.PagingLandscape.Page
{
    ...
    public class PageManager
    {
		...
		*/
        ...
        public long GetCurrentCameraPageX()
        {
            return this.currentCameraPageX;
        }
        public long GetCurrentCameraPageZ()
        {
            return this.currentCameraPageZ;
        }
        public long GetCurrentCameraTileX()
        {
            return this.currentCameraTileX;
        }
        public long GetCurrentCameraTileZ()
        {
            return this.currentCameraTileZ;
        }


        public int GetPagePreloadQueueSize()
        {
            return this.pagePreloadQueue.Size;
        }
        public int GetPageLoadQueueSize()
        {
            return this.pageLoadQueue.Size;
        }
        public int GetPageUnloadQueueSize()
        {
            return this.pageUnloadQueue.Size;
        }
        public int GetPagePostUnloadQueueSize()
        {
            return this.pagePostunloadQueue.Size;
        }
