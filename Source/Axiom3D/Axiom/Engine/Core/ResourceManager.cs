...
namespace Axiom
{
    ...
    public abstract class ResourceManager : IDisposable
    {
        ...
        public static ICollection CommonFilePaths
        {
            get
            {
                return commonFilePaths.Keys;
            }
        }
        public ICollection FilePaths
        {
            get
            {
        ...
        public ICollection ResourceNames
        {
            get
            {
        ...
        public Stream FindResourceData( string fileName )
        {
            ...
            if ( File.Exists( fileName ) )
            {
                ...
                LogManager.Instance.Write( "File '{0}' is being loaded manually since it exists, however it should be located in a registered media archive or directory." );
