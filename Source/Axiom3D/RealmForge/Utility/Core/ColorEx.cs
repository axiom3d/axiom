...
namespace Axiom.Core
{
    ...
    /// </summary>
    public class ColorEx : IComparable, IParsable
    {
        ...
        ///		Default constructor.
        /// </summary>
        public ColorEx( float grayLevel ) : this( 1.0f, grayLevel, grayLevel, grayLevel )
        {
        }
        ...
        public ColorEx( ParsingData data )
        {
            //parse it
            ColorEx color = Parse( data.Text );
            //copy the values
            this.a = color.a;
            this.r = color.r;
            this.b = color.b;
        ...
        #region Adjusting
        public ColorEx AdjustIntensity( float aIntensity, float rIntensity, float gIntensity, float bIntensity )
        {
            return new ColorEx(
                a * aIntensity,
                r * rIntensity,
        ...
        public ColorEx AdjustIntensity( float aIntensity, float colorIntensity )
        {
            return AdjustIntensity( aIntensity, colorIntensity, colorIntensity, colorIntensity );
        }

        public ColorEx AdjustIntensity( float colorIntensity )
        {
            return AdjustIntensity( 1f, colorIntensity );
        }


        public ColorEx Adjust( Color maxColorChange, float colorChangeIntensity )
        {
            return Adjust( ColorEx.FromColor( maxColorChange ), colorChangeIntensity );
        }

        public ColorEx Adjust( ColorEx maxColorChange, float colorChangeIntensity )
        {
            return Adjust( maxColorChange, 0f, colorChangeIntensity, colorChangeIntensity, colorChangeIntensity );
        }

        public ColorEx Adjust( ColorEx maxColorChange, float aChangeIntensity, float rChangeIntensity, float gChangeIntensity, float bChangeIntensity )
        {
        ...
        public ColorEx Adjust( float rChange, float gChange, float bChange )
        {
            return Adjust( 0, rChange, gChange, bChange );
        }
        public ColorEx Adjust( float aChange, float rChange, float gChange, float bChange )
        {
            return new ColorEx(
                ( a + aChange ) % 1f,
                ( r + rChange ) % 1f,
