...
namespace Axiom.RenderSystems.OpenGLES2
{
	...
	public class GLES2DefaultHardwareBufferManagerBase : HardwareBufferManagerBase
	{
		public GLES2DefaultHardwareBufferManagerBase()
			: base()
		{
		}
		...
		{
			return new GLES2DefaultHardwareVertexBuffer( declaration, numVerts, usage );
		}
	...
	/// 
	/// </summary>
	public class GLES2DefaultHardwareBufferManager : HardwareBufferManager
	{
		/// <summary>
		/// 
		/// </summary>
		public GLES2DefaultHardwareBufferManager()
			: base( new GLES2DefaultHardwareBufferManagerBase() )
		{
		}
	}
}
