...
namespace Axiom.FileSystem
{
	...
	public abstract class Archive : DisposableObject
	{
		...
		/// </summary>
		/// <remarks>
		///   This initializes all the internal data of the class. <para /> Do not call this function directly, it is meant to be used only by the ArchiveManager class.
		/// </remarks>
	...
	///<summary>
	///  abstract class for plugin developers to override to create new types of archive to load resources from.
	///</summary>
	///<remarks>
	///  All access to 'archives' (collections of files, compressed or just folders, maybe even remote) is managed via the abstract Archive class. Plugins are expected to provide the implementation for the actual codec itself, but because a subclass of Archive has to be created for every archive, a factory class is required to create the appropriate subclass. <para /> So archive plugins create a subclass of Archive AND a subclass of ArchiveFactory which creates instances of the Archive subclass. See the 'Zip' and 'FileSystem' plugins for examples. Each Archive and ArchiveFactory subclass pair deal with a single archive type (identified by a string).
	///</remarks>
