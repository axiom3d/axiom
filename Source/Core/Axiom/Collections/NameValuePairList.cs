...
namespace Axiom.Collections
{
	...
	public class NameValuePairList : Dictionary<string, string>
	{
		...
		/// <summary>
		///   Initializes a new instance of the <see cref="NameValuePairList" /> class that contains elements copied from the specified <see
		///    cref="NameValuePairList" /> and uses the default equality comparer for the key type.
		/// </summary>
