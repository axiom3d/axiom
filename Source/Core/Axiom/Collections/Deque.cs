...
{
	/// <summary>
	///   A double-ended queue. Provides fast insertion and removal from the head or tail end, and fast indexed access.
	/// </summary>
	...
	public class Deque<T> : ICollection<T>
	{
		...
		/// <summary>
		///   Gets or sets the capacity of the deque. If the count exceeds the capacity, the capacity will be automatically increased.
		/// </summary>
		public int Capacity
		{
			get
