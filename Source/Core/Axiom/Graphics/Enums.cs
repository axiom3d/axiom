...
namespace Axiom.Graphics
{
	...
	public enum BufferLocking
	{
		...
		///<summary>
		///  Discards the <em>entire</em> buffer while locking; this allows optimisation to be performed because synchronisation issues are relaxed. Only allowed on buffers created with the Dynamic flag.
		///</summary>
		Discard,

		///<summary>
		///  Lock the buffer for reading only. Not allowed in buffers which are created with WriteOnly. Mandatory on static buffers, ie those created without the Dynamic flag.
		///</summary>
		ReadOnly,

		/// <summary>
		///   As Normal, except the application guarantees not to overwrite any region of the buffer which has already been used in this frame, can allow some optimisation on some APIs.
		/// </summary>
		NoOverwrite
	}
	...
	public enum BufferUsage
	{
		...
		///<summary>
		///  Indicates the application would like to modify this buffer with the CPU sometimes. Absence of this flag means the application will never modify. Buffers created with this flag will typically end up in AGP memory rather than video memory.
		///</summary>
		Dynamic = 2,
		...
		/// <summary>
		///   Combination of Dynamic and WriteOnly. If you use this, strongly consider using DynamicWriteOnlyDiscardable instead if you update the entire contents of the buffer very regularly.
		/// </summary>
		DynamicWriteOnly = 6,
	...
	public enum Capabilities
	{
		...
		/// <summary>
		///   Supports using the MAIN depth buffer for RTTs. D3D 9&10, OGL w/FBO support unknown (undefined behavior?), OGL w/ copy supports it
		/// </summary>
		...
		/// <summary>
		///   Supports attaching a depth buffer to an RTT that has width & height less or equal than RTT's. Otherwise must be of _exact_ same resolution. D3D 9, OGL 3.0 (not 2.0, not D3D10)
		/// </summary>
	...
	public enum GpuProgramType
	{
		...
		/// <summary>
		///   Executes for each fragment (or pixel) for primitives that are passed through the pipeline while this program is active..
		/// </summary>
		Fragment,

		/// <summary>
		///   Executes for each geometry for primitives that are passed through the pipeline while this program is active..
		/// </summary>
		Geometry
	}
	...
	///<summary>
	///  Full and complete list of valid texture blending operations. Fallbacks will be required on older hardware that does not supports some of these multitexturing techniques.
	///</summary>
	...
	///<summary>
	///  Blending factors for manually blending objects with the scene. If there isn't a predefined SceneBlendType that you like, then you can specify the blending factors directly to affect the combination of object and the existing scene. See Material.SceneBlending for more details.
	///</summary>
	...
	public enum ShadowTechnique
	{
		...
		///<summary>
		///  Stencil shadow technique which renders each light as a separate additive pass to the scene. This technique can be very fillrate intensive because it requires at least 2 passes of the entire scene, more if there are multiple lights. However, it is a more accurate model than the modulative stencil approach and this is especially apparant when using coloured lights or bump mapping.
		///</summary>
		StencilAdditive,
		...
		///<summary>
		///  Texture-based shadow technique which involves a render-to-texture of the shadow caster and a projection of that texture onto the shadow receivers, followed by a depth test to detect the closest fragment to the light.
		///</summary>
		TextureAdditive
	}
	...
	public enum TextureUsage
	{
		...
		///<summary>
		///  This texture will be a render target, ie. used as a target for render to texture setting this flag will ignore all other texture usages except AutoMipMap
		///</summary>
		RenderTarget = 0x200,
	...
	///</summary>
	///<remarks>
	///  Implemented with the Flags attribute to treat this enum with bitwise addition and comparisons.
	///</remarks>
	[Flags]
	public enum VertexFlags
	{
		...
		///<summary>
		///  When applying 1 or more world matrices to a vertex, the weight values of a vertex dictate how much of an effect each matrix has in determining its final position.
		///</summary>
		BlendWeights = 2,

		///<summary>
		///  Normal vector, determines the logical direction the vertex is facing for use in lighting calculations.
		///</summary>
		Normals = 4,
