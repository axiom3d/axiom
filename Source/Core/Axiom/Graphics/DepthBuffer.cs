...
namespace Axiom.Graphics
{
	...
	public class DepthBuffer : DisposableObject
	{
		...
		/// <summary>
		///   Sets the pool id in which this DepthBuffer lives Note this will detach any render target from this depth buffer
		/// </summary>
		...
		/// <summary>
		///   Manual DepthBuffers are cleared in RenderSystem's destructor. Non-manual ones are released with it's render target (aka, a backbuffer or similar)
		/// </summary>
		[OgreVersion( 1, 7, 2790 )]
