...
namespace Axiom.Graphics
{
	...
	///</summary>
	///<remarks>
	///  This exists so we don't have to be dependent on an external media files. is used so we don't have to rely on particular plugins. assembler contents of this file were generated from the following Cg: <code>// Point light shadow volume extrude
