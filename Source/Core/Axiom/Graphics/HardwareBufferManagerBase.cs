...
namespace Axiom.Graphics
{
	public abstract class HardwareBufferManagerBase : DisposableObject
	{
		...
		///</summary>
		///<remarks>
		///  Subclasses wishing to override this methods should call the base class implementation first, which removes the object the collection of created objects.
		///</remarks>
 ...
 IHardwareBufferLicensee licensee, bool copyData = false )
...
#if !NET_40
		/// <see
		///   cref="HardwareBufferManager.AllocateVertexBufferCopy(HardwareVertexBuffer, BufferLicenseRelease, IHardwareBufferLicensee, bool)" />
		...
		/// </summary>
		/// <remarks>
		///   Only required if the original call to <see
		///    cref="AllocateVertexBufferCopy(HardwareVertexBuffer, BufferLicenseRelease, IHardwareBufferLicensee, bool)" /> included a licenseType of <see
		///    cref="BufferLicenseRelease.Manual" /> .
		/// </remarks>
		...
		/// <summary>
		///   Internal method for releasing all temporary buffers which have been allocated using <see
		///    cref="BufferLicenseRelease.Automatic" /> is called by Axiom.
		/// </summary>
		[OgreVersion( 1, 7, 2 )]
