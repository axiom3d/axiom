...
namespace Axiom.Animating
{
	...
	public class SkeletonInstance : Skeleton
	{
		...
		///<summary>
		///  Constructor, don't call directly, this will be created automatically when you create an <see cref="Entity" /> based on a skeletally animated Mesh.
		///</summary>
		...
		///<summary>
		///  Clones bones, for use in cloning the master skeleton to make this a unique skeleton instance.
		///</summary>
