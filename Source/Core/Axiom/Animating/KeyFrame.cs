...
namespace Axiom.Animating
{
	...
	public class KeyFrame
	{
		...
		///<summary>
		///  Creates a new keyframe with the specified time. Should really be created by <see cref="AnimationTrack.CreateKeyFrame" /> instead.
		///</summary>
	...
	public class TransformKeyFrame : KeyFrame
	{
		...
		///<summary>
		///  Sets the rotation applied by this keyframe. Use Quaternion methods to convert from angle/axis or Matrix3 if you don't like using Quaternions directly.
		///</summary>
		...
		///<summary>
		///  Sets the scaling factor applied by this keyframe to the animable object at its time index. beware of supplying zero values for any component of this vector, it will scale the object to zero dimensions.
		///</summary>
		...
		///</summary>
		///<remarks>
		///  The translation factor affects how much the keyframe translates (moves) its animable object at it's time index.
		///</remarks>
