...
namespace Axiom.Core
{
	...
	public interface ILodListener
	{
		...
		/// </summary>
		/// <remarks>
		///   Do not change the Axiom state from this method, instead return true and perform changes in PostqueueMovableObjectLodChanged.
		/// </remarks>
		...
		///</summary>
		///<remarks>
		///  Do not change the Axiom state from this method, instead return true and perform changes in PostqueueEntityMeshLodChanged. It is possible to change the event notification and even alter the newLodIndex field (possibly to prevent the lod from changing, or to skip an index).
		///</remarks>
		///<param name="evt"> </param>
		...
		///</summary>
		///<remarks>
		///  Do not change the Axiom state from this method, instead return true and perform changes in PostqueueMaterialLodChanged. It is possible to change the event notification and even alter the newLodIndex field (possibly to prevent the lod from changing, or to skip an index). <returns> True to indicate the event should be queued and PostqueueMaterialLodChanged called after rendering is complete. </returns>
		///</remarks>
		///<param name="evt"> </param>
