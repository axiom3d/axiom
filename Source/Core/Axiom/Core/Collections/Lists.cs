...
namespace Axiom.Core.Collections
{
	...
	/// </summary>
	/// <remarks>
	///   The items are sorted by their implicit index, it is important that the order of subentities in the collection maps to the order of submeshes in a <see
	///    cref="SubMeshList" />
	/// </remarks>
	...
	/// </summary>
	/// <remarks>
	///   The items are sorted by their implicit index, it is important that the order of submeshes in the collection maps to the order of subentities in a <see
	///    cref="SubEntityList" />
	/// </remarks>
