...
namespace Axiom.Math
{
	...
	public struct Matrix4
	{
		...
		///<summary>
		///  Gets/Sets the Scale portion of the matrix. |Sx 0 0 0 | | 0 Sy 0 0 | | 0 0 Sz 0 | | 0 0 0 0 |
		///</summary>
		///<remarks>
		///  Note that the property reflects the real scale only when there isn't any rotation, i.e. the 3x3 rotation portion of the matrix was a <see
		///   cref="Matrix3.Identity" /> before a scale was set. If you need to obtain the current scale of a rotated matrix, use the more expensive <see
		///   cref="ExtractRotation" /> method.
		///</remarks>
		...
		/// </summary>
		/// <remarks>
		///   Transforms the given 3-D vector by the matrix, projecting the result back into <i>w</i> = 1. The matrix must be an affine matrix. <see
		...
		///<summary>
		///  Transforms the given 3-D vector by the matrix, projecting the result back into <i>w</i> = 1. <p /> This means that the initial <i>w</i> is considered to be 1.0, and then all the tree elements of the resulting 3-D vector are divided by the resulting <i>w</i> .
		///</summary>
