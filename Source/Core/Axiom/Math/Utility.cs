...
namespace Axiom.Math
{
	public sealed class Utility
	{
		...
		/// <summary>
		///   Compares float values for equality, taking into consideration that floating point values should never be directly compared using the '==' operator. 2 floats could be conceptually equal, but vary by a float.Epsilon which would fail in a direct comparison.
		/// </summary>
		/// <param name="a"> </param>
		/// <param name="b"> </param>
		/// <returns> </returns>
		...
		/// <summary>
		///   Returns the sign of a real number. The result will be -1 for a negative number, 0 for zero and 1 for positive number.
		/// </summary>
		...
		/// <summary>
		///   Method delegate with a simple signature. Used to measure execution time of a method for instance.
		/// </summary>
