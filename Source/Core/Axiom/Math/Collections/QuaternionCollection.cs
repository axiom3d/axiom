...
namespace Axiom.Math.Collections
{
	...
	public class QuaternionCollection : ICollection, IList, IEnumerable, ICloneable
	{
		...
		///<summary>
		///  Creates a synchronized (thread-safe) wrapper for a <c>QuaternionCollection</c> instance.
		///</summary>
		...
		///<summary>
		///  Creates a read-only wrapper for a <c>QuaternionCollection</c> instance.
		///</summary>
		...
		///<summary>
		///  Initializes a new instance of the <c>QuaternionCollection</c> class that is empty and has the default initial capacity.
		///</summary>
		...
		///<summary>
		///  Initializes a new instance of the <c>QuaternionCollection</c> class that has the specified initial capacity.
		///</summary>
		...
		///<summary>
		///  Initializes a new instance of the <c>QuaternionCollection</c> class that contains elements copied from the specified <c>QuaternionCollection</c> .
		///</summary>
		...
		///<summary>
		///  Initializes a new instance of the <c>QuaternionCollection</c> class that contains elements copied from the specified <see
		///   cref="Quaternion" /> array.
		///</summary>
		...
		///<summary>
		///  Copies the entire <c>QuaternionCollection</c> to a one-dimensional <see cref="Quaternion" /> array.
		///</summary>
		...
		///<summary>
		///  Copies the entire <c>QuaternionCollection</c> to a one-dimensional <see cref="Quaternion" /> array, starting at the specified index of the target array.
		///</summary>
		///<param name="array"> The one-dimensional <see cref="Quaternion" /> array to copy to. </param>
		...
		///    <see cref="QuaternionCollection.Count" />
		///    .</para>
		///</exception>
		...
		///<summary>
		///  Returns the zero-based index of the first occurrence of a <see cref="Quaternion" /> in the <c>QuaternionCollection</c> .
		///</summary>
