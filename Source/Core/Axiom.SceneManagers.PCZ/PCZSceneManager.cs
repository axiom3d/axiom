...
namespace Axiom.SceneManagers.PortalConnected
{
	public struct LightInfo
	{
		...
		public override bool Equals( object obj )
		{
			...
			return light == rhs.light && type == rhs.type && range == rhs.range && position == rhs.position;
		}
	...
	public class PCZSceneManager : SceneManager
	{
			...
			: base( name )
		{
			...
			zoneFactoryManager = null;
			showPortals = false;
			defaultZoneTypeName = "ZoneType_Default";
			defaultZoneFileName = "none";
		...
		public void Init( string defaultZoneTypeName, string filename )
		{
			...
			defaultZone = CreateZoneFromFile( this.defaultZoneTypeName, "Default_Zone", RootSceneNode as PCZSceneNode,
			                                  defaultZoneFileName );
		}
		...
		public void FindVisibleObjects( Camera cam, VisibleObjectsBoundsInfo visibleBounds, bool onlyShadowCasters )
		{
			...
			cameraHomeZone.FindVisibleNodes( (PCZCamera)cam, ref visibleNodes, renderQueue, visibleBounds, onlyShadowCasters,
