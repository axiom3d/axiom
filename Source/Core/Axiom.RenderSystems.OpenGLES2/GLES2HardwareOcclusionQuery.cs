...
namespace Axiom.RenderSystems.OpenGLES2
{
    ...
    /// 
    /// Be sure to render all occluder first and what's out so the RenderQueue don't switch places on
    /// the occluding objects and tested object because it thinks it's more effective...
    /// </summary>
    class GLES2HardwareOcclusionQuery : HardwareOcclusionQuery
    {
        int _queryID;
