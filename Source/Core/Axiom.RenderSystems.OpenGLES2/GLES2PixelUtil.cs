...
namespace Axiom.RenderSystems.OpenGLES2
{
    ...
    static class GLES2PixelUtil
    {
        ...
        /// <returns>a GLenum describing the format, GLenum.Zero if there is no exactly
        /// matching one (and a conversion is need)</returns>
        ...
        /// <summary>
        /// Takes the Axiom pixel format format and returns the type that must be provided
        /// to GL as internal format. GLenum.None if no match exists
        /// </summary>
        ...
        /// to GL as internal format. If no match exists, returns the cloest match.
        /// </summary>
        /// <param name="format">The pixel format</param>
        ...
        /// <remarks>In case that the format is non-compressed, this simply returns
        ...
        /// RenderSystemCapabilities.NonPowerOf2Textures is supported it returns value as-is
        /// </summary>
