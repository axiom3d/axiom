...
namespace CeGuiSharp.WidgetSets.TaharezLook {
	/// <summary>
	/// Summary description for TLRadioButton.
	/// </summary>
	public class TLRadioButton : RadioButton {
		#region Constants
		...
		/// </summary>
		const string NormalImageName		= "RadioButtonNormal";
		/// <summary>
		///		Name of the image to use for the highlighted state.
		/// </summary>
		const string HighlightImageName		= "RadioButtonHover";
		/// <summary>
		///		Name of the image to use for the check / selected mark.
		/// </summary>
		const string CheckMarkImageName		= "RadioButtonMark";
		...
		public TLRadioButton(string type, string name) : base(type, name) {
