...
namespace CeGuiSharp.WidgetSets.WindowsLook {
	...
	/// 
	/// </summary>
	public class WLVerticalScrollbarThumb : Thumb
	{
		#region Constants
		...
		/// 
		/// </summary>
		protected const string	GripperImageName				= "VertScrollbarGrip";
		/// <summary>
		/// 
		/// </summary>
		...
		public WLVerticalScrollbarThumb( string type, string name ) : base(type, name) {
			StoreFrameSizes();
