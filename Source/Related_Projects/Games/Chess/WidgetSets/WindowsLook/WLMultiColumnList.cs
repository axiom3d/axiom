...
namespace CeGuiSharp.WidgetSets.WindowsLook {
	...
	/// </summary>
	public class WLMultiColumnList : MultiColumnList
	{
		#region Constants
		...
		/// </summary>
		const string	ListHeaderTypeName		= "WindowsLook.WLListHeader";
		...
		public WLMultiColumnList( string type, string name ) : base(type, name) {
		...
		/// <summary>
		///      Event trigger method for the <see cref="OnSized"/> event.
		/// </summary>
