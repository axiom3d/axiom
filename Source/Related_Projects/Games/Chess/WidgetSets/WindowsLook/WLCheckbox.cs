...
namespace CeGuiSharp.WidgetSets.WindowsLook {
	...
	/// 
	/// </summary>
	public class WLCheckbox : Checkbox
	{
		#region Constants
		...
		/// 
		/// </summary>
		protected const string	NormalImageName		= "CheckboxNormal";
		/// <summary>
		/// 
		/// </summary>
		protected const string	HighlightImageName	= "CheckboxHover";
		/// <summary>
		/// 
		/// </summary>
		protected const string	CheckMarkImageName	= "CheckboxMark";
		...
		public WLCheckbox( string type, string name ) : base(type, name) {
