...
namespace RealmForge.Input
{
    ...
    /// <summary>
    /// All possible buttons that can be found on a mouse.
    /// Values are identical to Axiom.Input.MouseButtons
    /// A left-handed user may have the right button set to act as the left or primary one
    /// </summary>
    [Flags]
...
namespace Axiom.Input
{
    ...
    {
        public const int MouseButtonCount = 3;
    }
    /// <summary>
