...
namespace Axiom.MathLib
{
    ...
    public sealed class MathUtil
    {
        ...
        public static Matrix4 BuildReflectionMatrix( Plane plane )
        {
            ...
            return new Matrix4(
                -2 * normal.x * normal.x + 1, -2 * normal.x * normal.y, -2 * normal.x * normal.z, -2 * normal.x * plane.Distance,
                -2 * normal.y * normal.x, -2 * normal.y * normal.y + 1, -2 * normal.y * normal.z, -2 * normal.y * plane.Distance,
                -2 * normal.z * normal.x, -2 * normal.z * normal.y, -2 * normal.z * normal.z + 1, -2 * normal.z * plane.Distance,
                0, 0, 0, 1 );
        }
        ...
        {
            return MathUtil.Abs( plane.Normal.DotProduct( sphere.Center ) ) <= sphere.Radius;
        }
