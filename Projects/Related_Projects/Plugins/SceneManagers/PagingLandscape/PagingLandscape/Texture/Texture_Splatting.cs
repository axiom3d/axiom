...
{
    public class Texture_Splatting : Texture
    {
        protected override void loadMaterial()
        {
            if (material == null)
            {
                if(!string.IsNullOrEmpty(Options.Instance.MaterialName))
                {
                    material = (Material)MaterialManager.Instance.GetByName(Options.Instance.MaterialName);
                }
                else
                {
                    material = (Material)MaterialManager.Instance.GetByName("SplattingMaterial");                    
                }
