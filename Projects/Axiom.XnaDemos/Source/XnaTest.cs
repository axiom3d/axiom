...
namespace Axiom.RenderSystems.Xna.Test
{
    class XnaTest : ExampleApplication.ExampleApplication
    {
        ...
        protected override void FrameStarted( object source, Axiom.Core.FrameEventArgs e )
        {
        ...
        protected override void CreateScene()
        {
            ...
            SceneNode node = this.SceneManager.RootSceneNode.CreateChildSceneNode();
            ...
            this.Camera.Position = new Vector3( 30, 30, 220 );

            this.RenderWindow.DebugText = "Spinning triangle - Using custom built geometry";
        }
    }
    ...
    public class Line3d : SimpleRenderable
    {
        ...
        public Line3d( Vector3 startPoint, Vector3 direction, float length, ColorEx color )
        {
            ...
            Material material = MaterialManager.Instance.GetByName( "Core/NodeMaterial" );
