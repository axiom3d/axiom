...
{
    /// <summary>
    /// Regression tests for the <see cref="SceneManager"/> class.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [ TestFixture ]
    public class SceneManagerRegressionTests
    {
        /// <summary>
        ...
        private class StubSceneManager : SceneManager
        {
            public StubSceneManager( string name )
                : base( name )
            {
            }
