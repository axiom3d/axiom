...
namespace Axiom.RenderSystems.SlimDX9
{
    ...
    /// </summary>
    public class SDXHardwareIndexBuffer : HardwareIndexBuffer
    {
        ...
        public SDXHardwareIndexBuffer( IndexType type, int numIndices, BufferUsage usage,
