...
//     <id value="$Id: SDXVertexDeclaration.cs 1075 2007-08-01 11:15:43Z borrillis $"/>
// </file>
...
{
    /// <summary>
    /// 	Summary description for SDXVertexDeclaration.
    /// </summary>
    public class SDXVertexDeclaration : VertexDeclaration
    {
        ...
        public SDXVertexDeclaration( D3D.Device device )
        {
            this.device = device;
        }
            ...
            get
            {
                ...
                if ( needsRebuild )
                {
                    ...
                    for ( int i = 0; i < elements.Count; i++ )
                    {
                        ...
                        d3dElements[ i ].Type = SDXHelper.ConvertEnum( element.Type );
                        d3dElements[ i ].Usage = SDXHelper.ConvertEnum( element.Semantic );
