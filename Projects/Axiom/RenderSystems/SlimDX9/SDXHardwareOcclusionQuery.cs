...
//     <id value="$Id: D3DHardwareOcclusionQuery.cs 884 2006-09-14 06:32:07Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.SlimDX9
{
    ...
    public class SDXHardwareOcclusionQuery : IHardwareOcclusionQuery
    {
        #region Fields
        ...
        public SDXHardwareOcclusionQuery( D3D.Device device )
        {
            this.device = device;
