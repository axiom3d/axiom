...
//     <id value="$Id: HLSLProgram.cs 884 2006-09-14 06:32:07Z borrillis $"/>
// </file>
...
namespace Axiom.RenderSystems.SlimDX9.HLSL
{
    /// <summary>
    ...
    public class HLSLProgram : HighLevelGpuProgram
    {
        ...
        protected override void CreateLowLevelImpl()
        {
            if ( !_compileError )
            {
                ...
                ( (SDXGpuProgram)assemblerProgram ).ExternalMicrocode = microcode;
            }
        }
        ...
        protected void ProcessParamElement( D3D.EffectHandle parent, string prefix, int index, GpuProgramParameters parms )
        {
            ...
            D3D.ConstantDescription[] descs = constantTable.GetConstantDescriptionArray( constant );
