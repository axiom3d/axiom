    ...
    public class XnaRenderSystem : RenderSystem, IServiceProvider
    {
        ...
        */
        ...
        private void _setCapabilitiesForAllProfiles()
        {
            ...
            Capabilities.SetCapability( Graphics.Capabilities.TextureCompression );
            Capabilities.SetCapability( Graphics.Capabilities.TextureCompressionDXT );

            // Xna uses vertex buffers for everything
            Capabilities.SetCapability( Graphics.Capabilities.VertexBuffer );

            // blending between stages is definitely supported
            Capabilities.SetCapability( Graphics.Capabilities.TextureBlending );
            Capabilities.SetCapability( Graphics.Capabilities.MultiTexturing );
        ...
        private void _setCapabilitiesForHiDefProfile()
        {
            ...
            Capabilities.SetCapability( Graphics.Capabilities.HardwareOcculusion );

            //VertexShaderVersion = 0x300;
            Capabilities.SetCapability( Graphics.Capabilities.VertexPrograms );
            Capabilities.MaxVertexProgramVersion = "vs_3_0";
            Capabilities.VertexProgramConstantIntCount = 16 * 4;
            Capabilities.VertexProgramConstantFloatCount = 256;
            ...
            Capabilities.SetCapability( Graphics.Capabilities.FragmentPrograms );
            Capabilities.MaxFragmentProgramVersion = "ps_3_0";
            Capabilities.FragmentProgramConstantIntCount = 16;
            Capabilities.FragmentProgramConstantFloatCount = 224;
            ...
            Capabilities.SetCapability( Graphics.Capabilities.AdvancedBlendOperations );
            ...
            //MaxVertexSamplers = 4;
            //MaxRenderTargets = 4;
            Capabilities.TextureUnitCount = 16;
            Capabilities.MultiRenderTargetCount = 4;
        ...
        private void _setCapabilitiesForReachProfile()
        {
            ...
            Capabilities.SetCapability( Graphics.Capabilities.VertexPrograms );
            Capabilities.MaxVertexProgramVersion = "vs_2_0";
            Capabilities.VertexProgramConstantIntCount = 16 * 4;
            Capabilities.VertexProgramConstantFloatCount = 256;
            this.gpuProgramMgr.PushSyntaxCode( "vs_1_1" );
            this.gpuProgramMgr.PushSyntaxCode( "vs_2_0" );
            ...
            Capabilities.SetCapability( Graphics.Capabilities.FragmentPrograms );
            Capabilities.MaxFragmentProgramVersion = "ps_2_0";
            Capabilities.FragmentProgramConstantIntCount = 0;
            Capabilities.FragmentProgramConstantFloatCount = 32;
            this.gpuProgramMgr.PushSyntaxCode( "ps_1_1" );
            this.gpuProgramMgr.PushSyntaxCode( "ps_1_2" );
            this.gpuProgramMgr.PushSyntaxCode( "ps_1_3" );
            this.gpuProgramMgr.PushSyntaxCode( "ps_1_4" );
        ...
        */
        ...
        /// </param>
        public override void SetStencilBufferParams( CompareFunction function, int refValue, int mask, StencilOperation stencilFailOp,
        ...
        public override void SetTextureBorderColor( int unit, ColorEx borderColor )
        {
            //texStageDesc[ unit ].borderColor = borderColor;
        }
        ...
        public override void SetTextureBlendMode( int unit, LayerBlendModeEx bm )
        {
            ...
            {
                texStageDesc[ unit ].layerBlendMode = bm;
            }
            /* TODO: use StateManager.BlendState */

            if ( bm.operation == LayerBlendOperationEx.BlendManual )
            {
                StateManager.BlendState.BlendFactor = new XNA.Color( bm.blendFactor, 0, 0, 0 );
            }
            if ( bm.blendType == LayerBlendType.Color )
            {
            ...
            if ( bm.blendType == LayerBlendType.Color )
            {
                manualD3D = new ColorEx( bm.blendFactor, bm.colorArg1.r, bm.colorArg1.g, bm.colorArg1.b );
            }
            else if ( bm.blendType == LayerBlendType.Alpha )
            {
                manualD3D = new ColorEx( bm.alphaArg1, bm.blendFactor, bm.blendFactor, bm.blendFactor );
            }
            ...
            for ( int i = 0; i < 2; i++ )
            {
                ...
                if ( bm.blendType == LayerBlendType.Color )
                {
                    if ( i == 0 )
                    {
                        texStageDesc[ unit ].layerBlendMode.colorArg1 = bm.colorArg1;
                    }
                    else if ( i == 1 )
                    {
                        texStageDesc[ unit ].layerBlendMode.colorArg2 = bm.colorArg2;
                    }
                }
                else if ( bm.blendType == LayerBlendType.Alpha )
                {
                    if ( i == 0 )
                    {
                        texStageDesc[ unit ].layerBlendMode.alphaArg1 = bm.alphaArg1;
                        basicEffect.Alpha = bm.alphaArg1;
                    }
                    else if ( i == 1 )
                    {
                        texStageDesc[ unit ].layerBlendMode.alphaArg2 = bm.alphaArg2;
        ...
        public override void SetTextureCoordCalculation( int unit, TexCoordCalcMethod method, Frustum frustum )
        {
            texStageDesc[ unit ].autoTexCoordType = method;
            texStageDesc[ unit ].frustum = frustum;
            //texStageDesc[unit].Enabled = true;
            //if (frustum != null) MessageBox.Show(texStageDesc[unit].Enabled.ToString());
        }
        ...
        public override void SetTextureLayerAnisotropy( int unit, int maxAnisotropy )
        {
            ...
            StateManager.SamplerStates[ unit ].MaxAnisotropy = maxAnisotropy;
        }
        ...
        public override void SetTextureUnitFiltering( int unit, FilterType type, FilterOptions filter )
        {
             ...
             */
            XnaTextureType texType = XnaHelper.Convert( texStageDesc[ unit ].texType );
            XFG.TextureFilter texFilter = XnaHelper.Convert( type, filter, texType );
            StateManager.SamplerStates[ unit ].Filter = texFilter;
        }
