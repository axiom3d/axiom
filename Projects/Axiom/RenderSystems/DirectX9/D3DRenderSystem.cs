...
namespace Axiom.RenderSystems.DirectX9
{
	...
	public class D3DRenderSystem : RenderSystem
	{
		...
		private List<D3DRenderWindow> _secondaryWindows = new List<D3DRenderWindow>();
		...
		{
			get { return D3DHelper.FromColor( device.GetRenderState<System.Drawing.Color>( D3D.RenderState.Ambient ) ); }
			set
			{
		...
		public override bool LightingEnabled { get { return device.GetRenderState<bool>( D3D.RenderState.Lighting ); } set { SetRenderState( D3D.RenderState.Lighting, value ); } }

		/// <summary>
		///
		/// </summary>
		public override bool NormalizeNormals { get { return device.GetRenderState<bool>( D3D.RenderState.NormalizeNormals ); } set { SetRenderState( D3D.RenderState.NormalizeNormals, value ); } }

		public override Shading ShadingMode
		{
			get { return D3DHelper.ConvertEnum( device.GetRenderState<D3D.ShadeMode>( D3D.RenderState.ShadeMode ) ); }
			set
			{
		...
		public override bool StencilCheckEnabled { get { return device.GetRenderState<bool>( D3D.RenderState.StencilEnable ); } set { SetRenderState( D3D.RenderState.StencilEnable, value ); } }
		...
		public override Axiom.Math.Matrix4 WorldMatrix { get { throw new NotImplementedException(); } set { device.SetTransform( D3D.TransformState.World, MakeD3DMatrix( value ) ); } }
		...
		{
			get { return device.GetRenderState<float>( D3D.RenderState.DepthBias ); }
			set
			{
		...
		///
		/// </summary>
		public override CompareFunction DepthFunction { get { throw new NotImplementedException(); } set { device.SetRenderState( D3D.RenderState.ZFunc, D3DHelper.ConvertEnum( value ) ); } }

		/// <summary>
		///
		/// </summary>
		public override bool DepthWrite { get { return device.GetRenderState<bool>( D3D.RenderState.ZWriteEnable ); } set { SetRenderState( D3D.RenderState.ZWriteEnable, value ); } }
		...
		/// </summary>
		/// <value></value>
		public override bool PointSprites { set { SetRenderState( D3D.RenderState.PointSpriteEnable, value ); } }
		...
		public void RestoreLostDevice()
		{
			...
			_primaryWindow.DisposeD3DResources();
