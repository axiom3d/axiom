...
public class TerrainZonePageSource
{
    ...
    /// </summary>
    protected TerrainZone TerrainZone
    {
        get { return _terrainZone; }
        set { _terrainZone = value; }
    }
    ...
    {
        get { return _asyncLoading; }
        set { _asyncLoading = value; }
    }
    ...
    public virtual TerrainZonePage BuildPage(Real[] heightData, Material material)
    {
        string name;
