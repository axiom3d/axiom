...
public class TerrainZoneRenderable : SimpleRenderable
{
	...
	/// </summary>
	public override AxisAlignedBox BoundingBox { get { return _bounds; } }
	...
	/// </summary>
	public override float BoundingRadius { get { return _boundingRadius; } }
	...
	new public void UpdateCustomGpuParameter( GpuProgramParameters.AutoConstantEntry constantEntry, GpuProgramParameters param )
	{
	...
	unsafe public int StitchEdge( Neighbor neighbor, int hiLOD, int loLOD, bool omitFirstTri, bool omitLastTri, ushort** ppIdx )
	{
	...
	/// </summary>
	new public bool NormalizeNormals { get { return _normalizeNormals; } }
	...
	///    simplicity.
	/// </remarks>
	new public ushort NumWorldTransforms { get { return _WorldTransformsCount; } }
	...
	///    not override this.
	/// </remarks>
	public override bool UseIdentityProjection { get { return _useIdentityProjection; } }
	...
	/// </remarks>
	public override bool UseIdentityView { get { return _useIdentityView; } }
	...
	/// </summary>
	public override bool PolygonModeOverrideable { get { return _polygonModeOverrideable; } }
	...
	/// </summary>
	public override Quaternion WorldOrientation { get { return _worldOrientation; } }
	...
	///    eliminates problems introduced by scaling.
	/// </summary>
	public override Vector3 WorldPosition { get { return _worldPosition; } }
