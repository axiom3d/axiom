	...
	public class QuaternionCollection : ICollection, IList, IEnumerable, ICloneable
	{
		...
		private void ValidateIndex( int i, bool allowEqualEnd )
		{
			...
			if ( i < 0 || i > max )
			{
				...
				throw new ArgumentOutOfRangeException( "Index was out of range.  Must be non-negative and less than the size of the collection.", i, "Specified argument was out of the range of valid values." );
			}
#else
		...
		private class Enumerator : IEnumerator, IQuaternionCollectionEnumerator
		{
			...
			#region IQuaternionCollectionEnumerator Members
