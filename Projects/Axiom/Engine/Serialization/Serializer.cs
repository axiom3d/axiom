...
namespace Axiom.Serialization
{
	...
	public class Serializer
	{
		...
		protected void ReadBytes( BinaryReader reader, int count, byte[] dest )
		{
		...
		protected void WriteBytes( BinaryWriter writer, int count, byte[] src )
		{
			for ( int i = 0; i < count; i++ )
			{
				writer.Write( src[ i ] );
		...
		/// <param name="count">Number of values to read.</param>
		/// <param name="dest">Pointer to copy the values into.</param>
		protected void ReadFloats( BinaryReader reader, int count, float[] dest )
		{
			// blast the data into the buffer
			for ( int i = 0; i < count; i++ )
			{
				dest[ i ] = ReadFloat( reader );
			}
		}
		...
		/// <param name="count">Number of values to write.</param>
		/// <param name="src">Pointer that holds the values.</param>
		protected void WriteFloats( BinaryWriter writer, int count, float[] src )
		{
			for ( int i = 0; i < count; i++ )
			{
				writer.Write( src[ i ] );
		...
		protected void ReadFloats( BinaryReader reader, int count, IMemoryBuffer dest, float[] destArray )
		{
			// blast the data into the buffer
			float[] pointer = new float[ count * sizeof( float ) ];
			dest.GetData( pointer, 0, count );
		...
		/// <param name="count">Number of values to read.</param>
		/// <param name="dest">Pointer to copy the values into.</param>
		protected void ReadInts( BinaryReader reader, int count, int[] dest )
		{
			// blast the data into the buffer\
			for ( int i = 0; i < count; i++ )
			{
				dest[ i ] = ReadInt( reader );
			}
		}
		...
		/// <param name="count">Number of values to write.</param>
		/// <param name="src">Pointer that holds the values.</param>
		protected void WriteInts( BinaryWriter writer, int count, int[] src )
		{
			// blast the data into the buffer
			for ( int i = 0; i < count; i++ )
			{
		...
		/// <param name="count">Number of values to read.</param>
		/// <param name="dest">Pointer to copy the values into.</param>
		protected void ReadShorts( BinaryReader reader, int count, short[] dest )
		{
			// blast the data into the buffer
			for ( int i = 0; i < count; i++ )
			{
				dest[ i ] = ReadShort( reader );
			}
		}
		...
		/// <param name="count">Number of values to write.</param>
		/// <param name="src">Pointer that holds the values.</param>
		protected void WriteShorts( BinaryWriter writer, int count, short[] src )
		{
			// blast the data into the buffer
			for ( int i = 0; i < count; i++ )
			{
