    ...
    public class Technique
    {
        ...
        internal bool CheckHardwareSupport( bool autoManageTextureUnits, ref StringBuilder compileErrors )
        {
            ...
            for ( int i = 0; i < _passes.Count; ++i )
            {
                ...
                if ( ( _passes[ i ].SceneBlendingOperation != SceneBlendOperation.Add || _passes[ i ].SceneBlendingOperationAlpha != SceneBlendOperation.Add ) && 
        ...
        internal bool CheckGPURules( ref StringBuilder errors )
        {
            ...
            foreach ( var i in _GPUDeviceNameRules )
            {
                ...
                bool checkCondition = i.CaseSensitive ? i.DevicePattern.Contains( caps.DeviceName ) : 
