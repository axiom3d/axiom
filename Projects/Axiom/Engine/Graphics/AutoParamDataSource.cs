...
namespace Axiom.Graphics
{
    ...
    public class AutoParamDataSource : DisposableObject
    {
        ...
        public virtual Vector4 GetSpotlightParams( int index )
        {
            ...
            {
                return new Vector4(
                    Utility.Cos( l.SpotlightInnerAngle * 0.5 ),
                    Utility.Cos( l.SpotlightOuterAngle * 0.5 ),
                    l.SpotlightFalloff,
                    1.0 );
            }
            else
        ...
        public virtual Matrix4 GetSpotlightViewProjMatrix( int index )
        {
            if ( index < Config.MaxSimultaneousLights )
            {
                ...
                if ( l != blankLight &&
                    ...
                    spotlightViewProjMatrixDirty[ index ] )
                {
        ...
        public virtual Matrix4 GetSpotlightWorldViewProjMatrix( int index )
        {
            if ( index < Config.MaxSimultaneousLights )
            {
                ...
                if ( l != blankLight &&
                    l.Type == LightType.Spotlight &&
                    spotlightWorldViewProjMatrixDirty[ index ] )
                {
        ...
        [OgreVersion( 1, 7, 2 )]
        public virtual SceneManager CurrentSceneManager
        {
            get;
            set;
        }
