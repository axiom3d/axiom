		...
		public static void Initialize()
		{
			...
			if ( !isInitialized )
			{
				...
				for ( int i = 0; i < programNames.Length; i++ )
				{
					...
					{
						string source = GetProgramSource( vertexProgramLightTypes[ i ], syntax, vertexProgramFinite[ i ], vertexProgramDebug[ i ] );
