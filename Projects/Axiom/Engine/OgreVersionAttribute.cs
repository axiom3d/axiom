...
namespace Axiom
{
    ...
    {
        public OgreVersionAttribute( int major, int minor, int revision) : this( major, minor, revision, String.Empty )
        {
        }
    ...
    {
        public AxiomHelperAttribute( int major, int minor ) : this( major, minor, String.Empty )
        {
        }
