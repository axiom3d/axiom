...
namespace Axiom.Media
{
    ...
    public class PixelConverter
    {
        ...
        protected static PixelFormatDescription[] IndexedPixelFormats;
        ...
        public static void PackColor( uint r, uint g, uint b, uint a, PixelFormat format, BufferBase dest )
        {
            ...
            if ( ( des.flags & PixelFormatFlags.NativeEndian ) != 0 )
            {
                ...
                uint value = ( ( ( Bitwise.FixedToFixed( r, 8, des.rbits ) << des.rshift ) & des.rmask ) | ( ( Bitwise.FixedToFixed( g, 8, des.gbits ) << des.gshift ) & des.gmask ) | ( ( Bitwise.FixedToFixed( b, 8, des.bbits ) << des.bshift ) & des.bmask ) | ( ( Bitwise.FixedToFixed( a, 8, des.abits ) << des.ashift ) & des.amask ) );
                // And write to memory
        ...
        public static void PackColor( float r, float g, float b, float a, PixelFormat format, BufferBase dest )
        {
            ...
            {
                // Do the packing
                uint value = ( ( Bitwise.FloatToFixed( r, des.rbits ) << des.rshift ) & des.rmask ) | ( ( Bitwise.FloatToFixed( g, des.gbits ) << des.gshift ) & des.gmask ) | ( ( Bitwise.FloatToFixed( b, des.bbits ) << des.bshift ) & des.bmask ) | ( ( Bitwise.FloatToFixed( a, des.abits ) << des.ashift ) & des.amask );
                // And write to memory
                Bitwise.IntWrite( dest, des.elemBytes, value );
            }
            else
        ...
        #region Nested type: PixelFormatDescription
        ...
        public class PixelFormatDescription
        {
            ...
            public byte abits; /*, ibits, dbits, ... */
            public uint amask;
            public byte ashift;
            public byte bbits; /*, ibits, dbits, ... */
            public uint bmask;
            public byte bshift;
            ...
            // Component type 
            public byte gbits; /*, ibits, dbits, ... */
            public uint gmask;
            public byte gshift;
            public string name;
            public byte rbits; /*, ibits, dbits, ... */
            public uint rmask;
            public byte rshift;
