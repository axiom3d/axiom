...
{
    public class DDSCodec : XnaImageCodec
    {
        #region XnaImageCodec Implementation

        public override object Decode( System.IO.Stream input, System.IO.Stream output, params object[] args )
        {
            ImageData data = new ImageData();

            Microsoft.Xna.Framework.Content.ContentManager content = new Microsoft.Xna.Framework.Content.ContentManager();
            return data;
        }
        ...
        #endregion XnaImageCodec Implementation
    }
}
