...
{
    internal class SDXMultiRenderTarget : MultiRenderTarget
    {
        protected SDXHardwarePixelBuffer[] _targets = new SDXHardwarePixelBuffer[Config.MaxMultipleRenderTargets];

        public SDXMultiRenderTarget( string name )
            : base( name )
        {
        }
        ...
        public override void BindSurface( int attachment, RenderTexture target )
        {
            ...
            SDXHardwarePixelBuffer buffer = (SDXHardwarePixelBuffer)( target[ "BUFFER" ] );
