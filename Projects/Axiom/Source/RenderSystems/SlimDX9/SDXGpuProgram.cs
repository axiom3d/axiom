...
namespace Axiom.RenderSystems.SlimDX9
{
    ...
    /// </summary>
    public abstract class SDXGpuProgram : GpuProgram
    {
        #region Fields
        ...
        public SDXGpuProgram( ResourceManager parent, string name, ResourceHandle handle, string group, bool isManual, IManualResourceLoader loader, D3D.Device device )
    ...
    /// </summary>
    public class SDXVertexProgram : SDXGpuProgram
    {
        #region Fields
        ...
        internal SDXVertexProgram( ResourceManager parent, string name, ResourceHandle handle, string group, bool isManual, IManualResourceLoader loader, D3D.Device device )
        ...
        {
            get { throw new AxiomException( "Attempted to query sample count for vertex shader." ); }
        }
    ...
    ///    Direct3D implementation of low-level vertex programs.
    /// </summary>
    public class SDXFragmentProgram : SDXGpuProgram
    {
        #region Fields
        ...
        internal SDXFragmentProgram( ResourceManager parent, string name, ResourceHandle handle, string group, bool isManual, IManualResourceLoader loader, D3D.Device device )
            : base( parent, name, handle, group, isManual, loader, device )
        {
