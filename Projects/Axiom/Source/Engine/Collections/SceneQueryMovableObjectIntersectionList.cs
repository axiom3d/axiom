...
namespace Axiom.Collections
{
    ...
    /// <summary>
    /// Represents a collection of <see cref="SceneQueryMovableObjectPair">SceneQueryMovableObjectPairs</see> that are sorted by name.
    /// </summary>
    public class SceneQueryMovableObjectIntersectionList : AxiomCollection<SceneQueryMovableObjectPair>
    {
    }
}
