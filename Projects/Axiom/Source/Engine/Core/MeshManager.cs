...
namespace Axiom.Core
{
    ...
    public class MeshManager : ResourceManager
    {
        ...
        public IEnumerable<string> MeshNames
        {
            get
            {
                return this.GetResourceNamesWithExtension( ".mesh" );
            }
        }
        ...
        /// <returns></returns>
        public PatchMesh CreateBezierPatch( string name, Array controlPointArray, VertexDeclaration declaration,
            ...
            BufferUsage vbUsage, BufferUsage ibUsage, bool vbUseShadow, bool ibUseShadow )
        {
            ...
            mesh = new PatchMesh( name, controlPointArray, declaration, width, height,
        ...
        public Mesh this[ int handle ]
        {
            get
            {
                return (Mesh)base.GetByHandle( handle );
            }
        }
    }
}
