...
namespace Axiom.Core
{
	...
	public class Camera : Frustum
	{
		...
		protected void SetWindowImpl()
		{
			...
			CalculateProjectionParameters( ref vpLeft, ref vpRight, ref vpBottom, ref vpTop );
		...
		/// </summary>
		/// <param name="screenLeft">the left bound of the on-screen rectangle, expressed in normalised screen coordinates [0,1]</param>
		/// <param name="screenTop">the upper bound of the on-screen rectangle, expressed in normalised screen coordinates [0,1]</param>
		/// <param name="screenRight">the right bound of the on-screen rectangle, expressed in normalised screen coordinates [0,1]</param>
		/// <param name="screenBottom">the lower bound of the on-screen rectangle, expressed in normalised screen coordinates [0,1]</param>
		/// <remarks>
		/// Can be useful for populating a PlaneBoundedVolumeListSceneQuery, e.g. for a rubber-band selection.
		/// </remarks>
		/// <returns></returns>
		public PlaneBoundedVolume GetCameraToViewportBoxVolume( Real screenLeft,
			Real screenTop, Real screenRight, Real screenBottom )
		{
			...
			else
			{
				...
				outVolume.planes.Add( new Plane( FrustumPlanes[ (int)FrustumPlane.Left ].Normal, br.Origin ) );
