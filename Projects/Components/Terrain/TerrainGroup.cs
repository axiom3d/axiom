...
namespace Axiom.Components.Terrain
{
	...
	public class TerrainGroup : IDisposable
	{
		...
		/// </summary>
		public ImportData DefaultImportSettings { get { return _defaultImportData; } }
		...
		/// </summary>
		public string FilenamePrefix { get { return _filenamePrefix; } set { _filenamePrefix = value; } }
		...
		/// </summary>
		public string ResourceGroup { get { return _resourceGroup; } set { _resourceGroup = value; } }
