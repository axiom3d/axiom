...
namespace Axiom.Components.RTShaderSystem
{
    class HardwareSkinningTechnique
    {
       ...
       protected Parameter paramOutPositionProj;
        ...
        internal void SetHardwareSkinningParam(int boneCount, int weightCount, bool correctAntipodalityHandling, bool scalingShearingSupport)
        {
        ...
        public int WeightCount { get { return weightCount; } }

        public bool HasCorrectAntipodalityHandling { get { return correctAntipodalityHandling; } }

        public bool HasScalingShearingSupport { get { return scalingShearingSupport; } }

        public bool DoBoneCalculations
        { 
            get { return doBoneCalculations; }
            set { doBoneCalculations = value; }
        }
