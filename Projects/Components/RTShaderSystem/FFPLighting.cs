...
{
    class FFPLighting : SubRenderState
    {
        class LightParams
        {
        ...
        Parameter vsInPosition, vsInNormal, vsDiffuse;
        Parameter vsOutDiffuse, vsOutSpecular;
        UniformParameter derivedSceneColor, lightAmbientColor, derivedAmbientLightColor;
        UniformParameter surfaceAmbientColor, surfaceDiffuseColor, 
            surfaceSpecularColor, surfaceEmissiveCoilor;
        ...
        public override void SetLightCount(int[] currLightCount)
        {
            for (int type = 0; type < 3; type++)
            {
                ...
                {
                    LightParams curParam = new LightParams();
                    if (type == 0)
        ...
        internal override bool ResolveParameters(ProgramSet programSet)
        {
            ...
            {
                derivedAmbientLightColor = vsProgram.ResolveAutoParameterInt(GpuProgramParameters.AutoConstantType.DerivedAmbientLightColor, 0);
                if (derivedAmbientLightColor == null)
                    return false;
            }
            else
            {
                lightAmbientColor = vsProgram.ResolveAutoParameterInt(GpuProgramParameters.AutoConstantType.AmbientLightColor, 0);
                if (lightAmbientColor == null)
                    return false;

                surfaceAmbientColor = vsProgram.ResolveAutoParameterInt(GpuProgramParameters.AutoConstantType.SurfaceAmbientColor, 0);
            ...
            if ((trackVertexColorType & TrackVertexColor.Diffuse) == 0)
            {
                surfaceDiffuseColor = vsProgram.ResolveAutoParameterInt(GpuProgramParameters.AutoConstantType.SurfaceDiffuseColor, 0);
            ...
            if ((trackVertexColorType & TrackVertexColor.Specular) == 0)
            {
                surfaceSpecularColor = vsProgram.ResolveAutoParameterInt(GpuProgramParameters.AutoConstantType.SurfaceSpecularColor, 0);
            ...
            {
                surfaceEmissiveCoilor = vsProgram.ResolveAutoParameterInt(GpuProgramParameters.AutoConstantType.SurfaceEmissiveColor, 0);
                if (surfaceEmissiveCoilor == null)
                    return false;
            }

            //Get derived scene color
            derivedSceneColor = vsProgram.ResolveAutoParameterInt(GpuProgramParameters.AutoConstantType.DerivedSceneColor, 0);
            if (derivedSceneColor == null)
                return false;

            //get surface shininess
            surfaceShininess = vsProgram.ResolveAutoParameterInt(GpuProgramParameters.AutoConstantType.SurfaceShininess, 0);
            ...
            {
                vsDiffuse = vsMain.ResolveInputParameter(Parameter.SemanticType.Color, 0, Parameter.ContentType.ColorDiffuse, GpuProgramParameters.GpuConstantType.Float4);
                if (vsDiffuse == null)
                    return false;
            }

            //Resolve output vertex shader diffuse color.
            vsOutDiffuse = vsMain.ResolveOutputParameter(Parameter.SemanticType.Color, 0, Parameter.ContentType.ColorDiffuse, GpuProgramParameters.GpuConstantType.Float4);
            ...
            for (int i = 0; i < lightParamsList.Count; i++)
            {
                ...
                {
                    case LightType.Directional:
                        lightParamsList[i].Direction = vsProgram.ResolveParameter(GpuProgramParameters.GpuConstantType.Float4, -1, GpuProgramParameters.GpuParamVariability.Lights, "light_position_view_space");
                    ...
                    case LightType.Point:
                        ...
                        lightParamsList[i].Position = vsProgram.ResolveParameter(GpuProgramParameters.GpuConstantType.Float4, -1, GpuProgramParameters.GpuParamVariability.Lights, "light_position_view_space");
                        if (lightParamsList[i].Position == null)
                            return false;

                        lightParamsList[i].AttenuatParams = vsProgram.ResolveParameter(GpuProgramParameters.GpuConstantType.Float4, -1, GpuProgramParameters.GpuParamVariability.Lights, "light_attenuation");
                    ...
                    case LightType.Spotlight:
                        ...
                        lightParamsList[i].Direction = vsProgram.ResolveParameter(GpuProgramParameters.GpuConstantType.Float4, -1, GpuProgramParameters.GpuParamVariability.Lights, "light_direction_view_space");
                        if (lightParamsList[i].Direction == null)
                            return false;
                        ...
                        lightParamsList[i].SpotParams = vsProgram.ResolveParameter(GpuProgramParameters.GpuConstantType.Float3, -1, GpuProgramParameters.GpuParamVariability.Lights, "spotlight_params");
                ...
                if ((trackVertexColorType & TrackVertexColor.Diffuse) == 0)
                {
                    lightParamsList[i].DiffuseColor = vsProgram.ResolveParameter(GpuProgramParameters.GpuConstantType.Float4, -1, GpuProgramParameters.GpuParamVariability.Global | GpuProgramParameters.GpuParamVariability.Lights, "derived_light_diffuse");
                    if (lightParamsList[i].DiffuseColor == null)
                        return false;
                }
                else
                {
                    lightParamsList[i].DiffuseColor = vsProgram.ResolveParameter(GpuProgramParameters.GpuConstantType.Float4, -1, GpuProgramParameters.GpuParamVariability.Lights, "light_diffuse");
                    if (lightParamsList[i].DiffuseColor == null)
                        return false;
                }
                ...
                if (specularEnable)
                {
                    ...
                    if ((trackVertexColorType & TrackVertexColor.Specular) == 0)
                    {
                        lightParamsList[i].SpecularColor = vsProgram.ResolveParameter(GpuProgramParameters.GpuConstantType.Float4, -1, GpuProgramParameters.GpuParamVariability.Global | GpuProgramParameters.GpuParamVariability.Lights, "derived_light_specular");
                        if (lightParamsList[i].SpecularColor == null)
                            return false;
                    }
                    else
                    {
                        lightParamsList[i].SpecularColor = vsProgram.ResolveParameter(GpuProgramParameters.GpuConstantType.Float4, -1, GpuProgramParameters.GpuParamVariability.Lights, "light_specular");
                        if (lightParamsList[i].SpecularColor == null)
                            return false;
                    }
                    ...
                    {
                        vsOutSpecular = vsMain.ResolveOutputParameter(Parameter.SemanticType.Color, 1, Parameter.ContentType.ColorSpecular, GpuProgramParameters.GpuConstantType.Float4);
                        if (vsOutSpecular == null)
                            return false;
                    }
        ...
        internal override bool AddFunctionInvocations(ProgramSet programSet)
        {
            ...
            if (!AddGlobalIlluminationInvocation(vsMain, (int)FFPRenderState.FFPVertexShaderStage.VSLighting, ref internalCounter))
                return false;

            //Add per light funcitons
            for (int i = 0; i < lightParamsList.Count; i++)
            {
                if (!AddIlluminationInvocation(lightParamsList[i], vsMain, (int)FFPRenderState.FFPVertexShaderStage.VSLighting,ref internalCounter))
                    return false;
            }
        ...
        private bool AddGlobalIlluminationInvocation(Function vsMain, int groupOrder, ref int internalCounter)
        {
            ...
            else
            {
                ...
                {
                    curFuncInvocation = new FunctionInvocation(FFPRenderState.FFPFuncAssign, groupOrder, internalCounter++);
                    curFuncInvocation.PushOperand(derivedAmbientLightColor, Operand.OpSemantic.In, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                    curFuncInvocation.PushOperand(vsOutDiffuse, Operand.OpSemantic.Out, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                    vsMain.AddAtomInstance(curFuncInvocation);
        ...
        private bool AddIlluminationInvocation(LightParams curLightParams, Function vsMain, int groupOrder, ref int internalCounter)
        {
            FunctionInvocation curFuncInvocation = null;
            ...
            {
                curFuncInvocation = new FunctionInvocation(FFPRenderState.FFPFuncModulate, groupOrder, internalCounter++);
                curFuncInvocation.PushOperand(vsDiffuse, Operand.OpSemantic.In, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                curFuncInvocation.PushOperand(curLightParams.DiffuseColor, Operand.OpSemantic.In, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                curFuncInvocation.PushOperand(curLightParams.DiffuseColor, Operand.OpSemantic.Out, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                vsMain.AddAtomInstance(curFuncInvocation);
            }
            ...
            if (specularEnable && (trackVertexColorType & TrackVertexColor.Specular) == TrackVertexColor.Specular)
            {
                curFuncInvocation = new FunctionInvocation(FFPRenderState.FFPFuncModulate, groupOrder, internalCounter++);
                curFuncInvocation.PushOperand(vsDiffuse, Operand.OpSemantic.In, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                curFuncInvocation.PushOperand(curLightParams.SpecularColor, Operand.OpSemantic.In, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                curFuncInvocation.PushOperand(curLightParams.SpecularColor, Operand.OpSemantic.Out, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                vsMain.AddAtomInstance(curFuncInvocation);
            }
            ...
            switch (curLightParams.Type)
            {
                case LightType.Directional:
                    if (specularEnable)
                    {
                        curFuncInvocation = new FunctionInvocation(FFPRenderState.FFPFuncLightDirectionDiffuseSpecular, groupOrder, internalCounter++);
                        ...
                        curFuncInvocation.PushOperand(curLightParams.Direction, Operand.OpSemantic.In, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                        curFuncInvocation.PushOperand(curLightParams.DiffuseColor, Operand.OpSemantic.In, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                        curFuncInvocation.PushOperand(curLightParams.SpecularColor, Operand.OpSemantic.In, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                        curFuncInvocation.PushOperand(surfaceShininess, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(vsOutDiffuse, Operand.OpSemantic.In, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                        curFuncInvocation.PushOperand(vsOutSpecular, Operand.OpSemantic.In, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                        curFuncInvocation.PushOperand(vsOutDiffuse, Operand.OpSemantic.Out, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                        curFuncInvocation.PushOperand(vsOutSpecular, Operand.OpSemantic.Out, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                        vsMain.AddAtomInstance(curFuncInvocation);
                    }
                    else
                    {
                        curFuncInvocation = new FunctionInvocation(FFPRenderState.FFPFuncLightDirectionDiffuse, groupOrder, internalCounter++);
                        curFuncInvocation.PushOperand(worldViewITMatrix, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(vsInNormal, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(curLightParams.Direction, Operand.OpSemantic.In, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                        curFuncInvocation.PushOperand(curLightParams.DiffuseColor, Operand.OpSemantic.In, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                ...
                case LightType.Point:
                    if (specularEnable)
                    {
                        curFuncInvocation = new FunctionInvocation(FFPRenderState.FFPFuncLightPointDiffuseSpecular, groupOrder, internalCounter++);
                        curFuncInvocation.PushOperand(worldViewMatrix, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(vsInPosition, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(worldViewITMatrix, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(vsInNormal, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(curLightParams.Position, Operand.OpSemantic.In, (Operand.OpMask.X | Operand.OpMask.Y | Operand.OpMask.Z));
                    ...
                    {
                        curFuncInvocation = new FunctionInvocation(FFPRenderState.FFPFuncLightPointDiffuse, groupOrder, internalCounter++);
                        curFuncInvocation.PushOperand(worldViewMatrix, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(vsInPosition, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(worldViewITMatrix, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(vsInNormal, Operand.OpSemantic.In);
                ...
                case LightType.Spotlight:
                    if (specularEnable)
                    {
                        curFuncInvocation = new FunctionInvocation(FFPRenderState.FFPFuncLightSpotDiffuseSpecular, groupOrder, internalCounter++);
                        curFuncInvocation.PushOperand(worldViewITMatrix, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(vsInPosition, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(worldViewITMatrix, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(vsInNormal, Operand.OpSemantic.In);
                    ...
                    {
                        curFuncInvocation = new FunctionInvocation(FFPRenderState.FFPFuncLightSpotDiffuse, groupOrder, internalCounter++);
                        curFuncInvocation.PushOperand(worldViewMatrix, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(vsInPosition, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(worldViewITMatrix, Operand.OpSemantic.In);
                        curFuncInvocation.PushOperand(vsInNormal, Operand.OpSemantic.In);
        ...
        TrackVertexColor TrackVertexColorType
        {
            get { return this.trackVertexColorType; }
