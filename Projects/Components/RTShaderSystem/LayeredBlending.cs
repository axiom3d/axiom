...
namespace Axiom.Components.RTShaderSystem
{
    public class LayeredBlending : FFPTexturing
    {
        ...
        private static string SGXLibLayeredBlending = "SGXLib_LayeredBlending";
        private List<TextureBlend> textureBlends;

        public static BlendModeDescription[] blendModes = new BlendModeDescription[]
                                                          {
                                                              new BlendModeDescription()
                                                              {
                                                                  Type = BlendMode.FFPBlend,
                                                                  Name = "default",
                                                                  FuncName = ""
                                                              },
                                                              new BlendModeDescription()
                                                              ...
                                                              new BlendModeDescription()
                                                              {
                                                                  Type = BlendMode.Lighten,
                                                                  Name = "lighten",
                                                                  FuncName = "SGX_blend_lighten"
                                                              },
                                                              new BlendModeDescription()
                                                              {
                                                                  Type = BlendMode.Darken,
                                                                  Name = "darken",
                                                              ...
                                                              new BlendModeDescription()
                                                              {
                                                                  Type = BlendMode.Negation,
                                                                  Name = "negation",
                                                                  FuncName = "SGX_blend_negation"
                                                              },
                                                              new BlendModeDescription()
                                                              {
                                                                  Type = BlendMode.Exclusion,
                                                                  Name = "exclusion",
                                                                  FuncName = "SGX_blend_exclusion"
                                                              },
                                                              new BlendModeDescription()
                                                              {
                                                                  Type = BlendMode.Screen,
                                                                  Name = "screen",
                                                              ...
                                                              new BlendModeDescription()
                                                              {
                                                                  Type = BlendMode.Phoenix,
                                                                  Name = "phoenix",
                                                                  FuncName = "SGX_blend_phoenix"
                                                              },
                                                              new BlendModeDescription()
                                                              {
                                                                  Type = BlendMode.Saturation,
                                                                  Name = "saturation",
                                                                  FuncName = "SGX_blend_saturation"
                                                              },
                                                              new BlendModeDescription()
                                                              {
                                                                  Type = BlendMode.Color,
                                                                  Name = "color",
                                                                  FuncName = "SGX_blend_color"
                                                              },
                                                              new BlendModeDescription()
                                                              {
                                                                  Type = BlendMode.Luminosity,
                                                                  Name = "luminosity",
        ...
        public static SourceModifierDescription[] sourceModifiers = new SourceModifierDescription[]
                                                                    {
                                                                        new SourceModifierDescription()
                                                                        {
                                                                            Type = SourceModifier.None,
                                                                            Name = string.Empty,
                                                                            FuncName = string.Empty
                                                                        },
                                                                        new SourceModifierDescription()
                                                                        {
                                                                            Type = SourceModifier.Source1Modulate,
                                                                            Name = "src1_modulate",
                                                                            FuncName = string.Empty
                                                                        },
                                                                        new SourceModifierDescription()
                                                                        {
                                                                            Type = SourceModifier.Source2Modulate,
                                                                            Name = "src2_modulate",
                                                                            FuncName = string.Empty
                                                                        },
                                                                        new SourceModifierDescription()
                                                                        {
                                                                            Type = SourceModifier.Source1InvModulate,
                                                                            Name = "src1_inverse_modulate",
                                                                            FuncName = string.Empty
                                                                        },
                                                                        new SourceModifierDescription()
                                                                        {
                                                                            Type = SourceModifier.Source2InvModulate,
                                                                            Name = "src2_inverse__modulate",
                                                                            FuncName = string.Empty
                                                                        },
                                                                    };
