...
namespace Axiom.Components.RTShaderSystem
{
    class Program : IDisposable
    {
        ...
        public UniformParameter ResolveAutoParameterReal(GpuProgramParameters.AutoConstantType autoType, Real data, int size)
        {
        ...
        /// <param name="size">number of elements in the parameter</param>
        /// <returns>parameter instance in case of that resolve operation succeeded, otherwise null</returns>
        public UniformParameter ResolveAutoParameterReal(GpuProgramParameters.AutoConstantType autoType, Axiom.Graphics.GpuProgramParameters.GpuConstantType type, Real data, int size)
        {
            UniformParameter param = null;
        ...
        /// <param name="size">number of elements in the parameter</param>
        /// <returns></returns>
        public UniformParameter ResolveAutoParameterInt(GpuProgramParameters.AutoConstantType autoType, int data, int size)
        {
            UniformParameter param = null;
        ...
        /// <param name="size">number of elements in the parameter</param>
        /// <returns></returns>
        public UniformParameter ResolveAutoParameterInt(GpuProgramParameters.AutoConstantType autoType, Axiom.Graphics.GpuProgramParameters.GpuConstantType type, int data, int size)
        {
        ...
        public UniformParameter ResolveParameter(Axiom.Graphics.GpuProgramParameters.GpuConstantType type, int index, GpuProgramParameters.GpuParamVariability variability, string suggestedName)
        {
            return this.ResolveParameter(type, index, variability, suggestedName, 0);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public UniformParameter ResolveParameter(Axiom.Graphics.GpuProgramParameters.GpuConstantType type, int index, GpuProgramParameters.GpuParamVariability variability, string suggestedName, int size)
        {
            UniformParameter param = null;
        ...
        /// <summary>
        /// Add dependency for this program. Basically a filename that will be included in this program
        /// and provide predefined shader functions code
        ...
        {
            get { return entryPointFunction; }
            set { entryPointFunction = value; }
        }
