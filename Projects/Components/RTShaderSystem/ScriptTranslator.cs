...
namespace Axiom.Components.RTShaderSystem
{
    public class SGScriptTranslator : Axiom.Scripting.Compiler.ScriptCompiler.Translator
    {
        ...
        public override void Translate(Scripting.Compiler.ScriptCompiler compiler, Scripting.Compiler.AST.AbstractNode node)
        {
            
            ObjectAbstractNode obj = (ObjectAbstractNode)node;
            ObjectAbstractNode parent = (ObjectAbstractNode)obj.Parent;
        ...
        private void TranslatePass(Scripting.Compiler.ScriptCompiler compiler, AbstractNode node)
        {
            ...
            techniqueCreated = shaderGenerator.CreateShaderBasedTechnique(material.Name, material.Group, technique.SchemeName, dstTechniqueSchemeName, shaderGenerator.CreateShaderOverProgrammablePass);
            ...
            if (techniqueCreated)
            {
                ...
                for (int i = 0; i < obj.Children.Count; i++)
                {
                    ...
                    {
                        PropertyAbstractNode prop = obj.Children[i] as PropertyAbstractNode;
                        ...
                        if (prop.Name == "light_count")
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    RenderState renderState = shaderGenerator.GetRenderState(dstTechniqueSchemeName, material.Name, material.Group, (ushort)pass.Index);
                        ...
                        else
                        {
                            ...
                            {
                                AddSubRenderState(subRenderState, dstTechniqueSchemeName, material.Name, material.Group, pass.Index);
                            }
                        }
                    }
                    else
        ...
        {
            ObjectAbstractNode obj = (ObjectAbstractNode)node;
            TextureUnitState texState = (TextureUnitState)obj.Parent.Context;
            ...
            techniqueCreated = shaderGenerator.HasShaderBasedTechnique(material.Name, material.Group, technique.SchemeName, dstTechniqueSchemeName);
            ...
            if (techniqueCreated)
            {
                ...
                generatedRenderState = shaderGenerator.GetRenderState(dstTechniqueSchemeName, material.Name, material.Group, (ushort)pass.Index);
                ...
                for (int i = 0; i < obj.Children.Count; i++)
                {
                    ...
                    {
                        PropertyAbstractNode prop = obj.Children[i] as PropertyAbstractNode;
                        SubRenderState subRenderState = ShaderGenerator.Instance.createSubRenderState(compiler, prop, texState, this);
        ...
        private void AddSubRenderState(SubRenderState newSubRenderState, string dstTechniqueSchemeName, string materialNem,
            string groupName, int passIndex)
        {
            ...
            generatedRenderState = shaderGenerator.GetRenderState(dstTechniqueSchemeName, materialNem, (ushort)passIndex);
