...
namespace Axiom.Components.RTShaderSystem
{
    ...
    class SkinningData
    {
       ...
       public SkinningData()
       { }
       public SkinningData(bool isValid, int maxBoneCount, int maxWeightCount, SkinningType sType, bool correctAntipodality, bool scalingShearingSupport)
       {
    ...
    class HardwareSkinning : SubRenderState
    {
        public static string SGXType = "SGX_HardwareSkinning";
        public static string HsDataBindName = "HS_SRS_DATA";
        HardwareSkinningFactory creator;
        SkinningType skinningType;
        DualQuaternionSkinning dualQuat;
        LinearSkinning linear;
        HardwareSkinningTechnique activeTechnique;
        ...
        public void SetHardwareSkinningParam(int boneCount, int weightCount, SkinningType skinningType, bool correctAntipodalityHandling, bool scalingShearingSupport)
        {
            ...
            activeTechnique.SetHardwareSkinningParam(boneCount, weightCount, correctAntipodalityHandling, scalingShearingSupport);
        }
        public override bool PreAddToRenderState(TargetRenderState targetRenderState, Graphics.Pass srcPass, Graphics.Pass dstPass)
        {
            ...
            bool doBoneCalculations = isValid && (boneCount != 0) && (boneCount <= 256) && (weightCount != 0) && (weightCount <= 4) && ((creator == null) || (boneCount <= creator.MaxCalculableBoneCount));
        ...
        {
            get { return activeTechnique.BoneCount; }
        }
        public int WeightCount
        {
            get { return activeTechnique.WeightCount; }
        }
        public SkinningType SkinningType
        {
            get { return skinningType; }
        }
        public bool HasCorrectAntipodalityHandling
        {
            get { return activeTechnique.HasCorrectAntipodalityHandling; }
        }
        public bool HasScalingShearingSupport
        {
            get { return activeTechnique.HasScalingShearingSupport; }
        }
