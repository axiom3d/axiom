...
{
    class GLSLProgramWriter : ProgramWriter
    {
        ...
        internal override void WriteSourceCode(System.IO.StreamWriter stream, Program program)
        {
            ...
            foreach (var curFunction in functionList)
            {
                ...
                {
                    FunctionInvocation funcInvoc = itAtom as FunctionInvocation;
        ...
        private void WriteForwardDeclarations(StreamWriter stream, Program program)
        {
            ...
            List<string> forwardDecl = new List<string>();// hold all generated function declarations
            var functionList = program.Functions;
            ...
            foreach (var curFunction in functionList)
            {
                ...
                for (int i = 0; i < atomInstances.Count; i++)
                {
                    ...
                    while (itOperator != itOperatorEnd)
                    {
                        ...
                        Axiom.Graphics.GpuProgramParameters.GpuConstantType gpuType = GpuProgramParameters.GpuConstantType.Unknown;
                        ...
                        while ((itOperator != itOperatorEnd) && (funcInvoc.OperandList[itOperator].IndirectionLevel != 0)) 
                        {
                            itOperator++;
                        }
