...
namespace Axiom.Components.RTShaderSystem
{
    ...
    {
        List<Program> cpuProgramList;
        Dictionary<string, ProgramWriter> programWritersMap;
        Dictionary<string, ProgramProcessor> programProcessorMap;
        List<ProgramWriterFactory> programWriterFactories;
        Dictionary<string, GpuProgram> vertexShaderMap;
        Dictionary<string, GpuProgram> fragmentShaderMap;
        List<ProgramProcessor> defaultProgramProcessors;
        ...
        {
            Program shaderProgram = new Program(gpuProgramType);
...
//#endif
        ...
        private bool CreateGpuPrograms(ProgramSet programSet)
        {
            ...
            //update flags
            programSet.GpuVertexProgram.IsSkeletalAnimationIncluded = programSet.CpuVertexProgram.SkeletalAnimationIncluded;
        ...
        private GpuProgram CreateGpuProgram(Program shaderProgram, ProgramWriter programWriter, string language, string profiles, string[] profilesList, string cachePath)
        {
            ...
            if (gpuProgram == null)
            {
                ...
                gpuProgram = HighLevelGpuProgramManager.Instance.CreateProgram(programName, ResourceGroupManager.DefaultResourceGroupName, language, shaderProgram.Type);
                ...
                if (cachePath == string.Empty)
                {
                    ...
                    if (writeFile)
                    {
                        StreamWriter outFile = new StreamWriter(programFileName);
        ...
        {
            get { return vertexShaderMap.Count; }
        }

        public int FragmentShaderCount
        {
            get { return fragmentShaderMap.Count; }
        }
