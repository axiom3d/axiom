...
{
    class LayerBlendingFactory : SubRenderStateFactory
    {
        public override string Type
        {
            get { return LayeredBlending.LBType; }
        }
        ...
        LayeredBlending.SourceModifier StringToSourceModifier(string strValue)
        {
        ...
        public override SubRenderState CreateInstance(Scripting.Compiler.ScriptCompiler compiler, Scripting.Compiler.AST.PropertyAbstractNode prop, Graphics.TextureUnitState texState, SGScriptTranslator translator)
        {
            ...
            if (prop.Name == "layered_blend")
            {
                ...
                LayeredBlending layeredBlendState = (LayeredBlending)CreateOrRetrieveInstance(translator);
        ...
        public override void WriteInstance(Serialization.MaterialSerializer ser, SubRenderState subRenderState, Graphics.TextureUnitState srcTextureUnit, Graphics.TextureUnitState dstTextureUnit)
        {
            ...
            LayeredBlending layeredBlendingSubRenderState = subRenderState as LayeredBlending;
        ...
        private LayeredBlending CreateOrRetrieveSubRenderState(SGScriptTranslator translator)
        {
            ...
            SubRenderState subState = translator.GetGeneratedSubRenderState(this.Type);
            if (subState != null)
            {
