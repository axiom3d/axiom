...
namespace Axiom.Components.RTShaderSystem
{
    public abstract class SubRenderState : RenderState
    {
        ...
        public virtual bool PreAddToRenderState(TargetRenderState targetRenderState, Graphics.Pass srcPass, Graphics.Pass dstPass)
        {
            return true;
        }
    ...
    public abstract class SubRenderStateFactory
    {
        ...
        internal virtual SubRenderState CreateOrRetrieveInstance(SGScriptTranslator translator)
        {
            ...
            SubRenderState subRenderState = translator.GetGeneratedSubRenderState(this.Type);
