...
namespace Axiom.Demos
{
	...
	public class CubeMapping : TechDemo
	{
		...
		///
		/// </summary>
		unsafe private void UpdateNoise()
		{
		...
		unsafe private void UpdateVertexDataNoiseAndNormals( VertexData dstData, VertexData orgData, IndexData indexData, float* normals )
		{
		...
		/// <param name="vertexData"></param>
		/// <returns></returns>
		unsafe private float* NormalsGetCleared( VertexData vertexData )
		{
		...
		/// <param name="vertexData"></param>
		/// <param name="normals"></param>
		unsafe private void NormalsSaveNormalized( VertexData vertexData, float* normals )
		{
			VertexElement element = vertexData.vertexDeclaration.FindElementBySemantic( VertexElementSemantic.Normal );
			HardwareVertexBuffer buffer = vertexData.vertexBufferBinding.GetBuffer( element.Source );
