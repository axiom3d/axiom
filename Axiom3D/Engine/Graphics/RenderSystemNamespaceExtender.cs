...
namespace Axiom
{
    ...
    public class RenderSystemNamespaceExtender : INamespaceExtender
    {
        ...
        /// </summary>
        protected RenderSystemCollection renderSystems = new RenderSystemCollection();
        ...
        {
            if ( typeof( K ) != typeof( RenderSystem ) && !typeof( K ).IsSubclassOf( typeof( RenderSystem ) ) )
        ...
        const string NAMESPACE_NAME = "/Axiom/RenderSystems/";
