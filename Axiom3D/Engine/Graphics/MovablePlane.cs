...
namespace Axiom
{
    ...
    public class MovablePlane : MovableObject, IDerivedPlaneProvider
    {
        ...
        public Real Distance
        {
            get
            {
                return containedPlane.Distance;
            }
            set
            {
                containedPlane.Distance = value;
            }
        }
            ...
            get
            {
                if ( parentNode != null )
                {
                        ...
                        parentNode.DerivedPosition == lastTranslate ) )
                    {
                        ...
                        derivedPlane.Distance = containedPlane.Distance;

                        // add on the effect of the translation (project onto new normal)
                        derivedPlane.Distance -= derivedPlane.Normal.DotProduct( lastTranslate );
