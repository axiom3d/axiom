...
namespace Axiom
{
    ...
    public sealed class LogManager : IDisposable
    {
        ...
        /// </summary>
        internal LogManager( Axiom.Configuration.LogSettings settings )
        {
            if ( instance == null )
            {
                instance = this;
        ...
        private void _initialize( Axiom.Configuration.LogSettings settings )
        {
            if ( settings.LogFile.Length != 0 )
            {
                CreateLog( settings.LogFile, true, true );
            }
        }
