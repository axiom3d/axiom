...
namespace Axiom.FileSystem
{
    ...
    public class FileSystemArchive : Archive
    {
        ...
        public override bool IsCaseSensitive
        {
            get
            {
                return !PlatformManager.WindowsOS;
            }
        }
    ...
    ///     <file name="OgreFileSystem.cpp" revision="1.8" lastUpdated="5/18/2006" lastUpdatedBy="Borrillis" />
    /// </ogre> 
    public class FileSystemArchiveFactory : IArchiveFactory
    {
        private const string _type = "FileSystem";
