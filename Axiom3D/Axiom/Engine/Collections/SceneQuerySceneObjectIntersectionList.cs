...
namespace Axiom
{
    [Obsolete( "Please use SceneQueryMovableObjectPair." )]
    ...
    /// </summary>
    [Obsolete( "Please use SceneQueryMovableObjectIntersectionList" )]
    public class SceneQuerySceneObjectIntersectionList : List<SceneQuerySceneObjectPair>
    {
