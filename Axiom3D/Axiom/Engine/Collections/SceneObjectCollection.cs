...
//using T = Axiom.Core.SceneObject;
...
namespace Axiom
{
    ...
    /// </summary>
    //public class SceneObjectCollection : AxiomCollection<string, Axiom.Core.Mo>
    //{
    //    #region Constructors
    ...
    //    ///		Default constructor.
    //    /// </summary>
    //    public SceneObjectCollection() : base() { }

    //    #endregion



    //    public override void Add(SceneObject item)
    //    {
    //        if (item.Name == string.Empty)
    //            base.Add("SceneObject" + nextUniqueKeyCounter++, item);
    //        else
