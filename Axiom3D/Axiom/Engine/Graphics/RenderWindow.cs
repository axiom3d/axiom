...
namespace Axiom
{
    ...
    ///		of a scene are rendered. There may be
    ///		more than one render window (in the case of level editor tools etc.) per RenderSystem instance (which controls the rendering of the scene).
