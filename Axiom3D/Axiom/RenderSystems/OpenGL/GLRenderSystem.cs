    ...
    public class GLRenderSystem : RenderSystem
    {
        ...
        private void CheckCaps()
        {
            ...
            if ( glSupport.CheckExtension( "GL_ATI_fragment_shader" ) )
            {
                ...
                gpuProgramMgr.RegisterProgramFactory( "ps_1_1", new ATIFragmentShaderFactory() );
                gpuProgramMgr.RegisterProgramFactory( "ps_1_2", new ATIFragmentShaderFactory() );
                gpuProgramMgr.RegisterProgramFactory( "ps_1_3", new ATIFragmentShaderFactory() );
                gpuProgramMgr.RegisterProgramFactory( "ps_1_4", new ATIFragmentShaderFactory() );
            }
                ...
                glSupport.CheckExtension( "GL_NV_texture_shader" ) )
            {
                ...
                gpuProgramMgr.RegisterProgramFactory( "fp20", new NvparseProgramFactory() );
            }
            ...
            if ( glSupport.CheckExtension( "GL_NV_vertex_program2" ) )
            {
                ...
                gpuProgramMgr.RegisterProgramFactory( "vp30", new NV3xGpuProgramFactory() );
            }
            ...
            if ( glSupport.CheckExtension( "GL_NV_fragment_program" ) )
            {
                ...
                gpuProgramMgr.RegisterProgramFactory( "fp30", new NV3xGpuProgramFactory() );
            }
