            ...
            else if ( Options.Instance.Data2DFormat == "ClientGen" )
            {
                ...
                for ( j = 0; j < h; j++ )
                {
                    ...
                    for ( i = 0; i < w; i++ )
                    {
                        ...
                        data2D[ i ][ j ] = new Data2D_Dynamic( (int)i, (int)j );
...
*/
        ...
        public Real GetHeight( long dataX, long dataZ, Real x, Real z )
        {
            Data2D data = data2D[ dataX ][ dataZ ];
            if ( data.IsLoaded )
            {
        ...
        public Real GetHeight( long dataX, long dataZ, long x, long z )
        {
            Data2D data = data2D[ dataX ][ dataZ ];
            if ( data.IsLoaded )
            {
        ...
        public Real GetHeightAtPage( long dataX, long dataZ, Real x, Real z )
        {
            Data2D data = null;

            Real lX = x;
            Real lZ = z;
            Real pSize = Options.Instance.PageSize;
        ...
        public Real GetHeightAtPage( long dataX, long dataZ, int x, int z )
        {
            Data2D data = data2D[ dataX ][ dataZ ];
        ...
        public void DeformHeight( Vector3 deformationPoint, Real modificationHeight, TileInfo info )
        {
            ...
            if ( data.IsLoaded )
            {
                Real h = data.DeformHeight( x, z, modificationHeight );
        ...
        public Real GetMaxHeight( long x, long z )
        {
        ...
        */
        public Real GetRealWorldHeight( Real x, Real z )
        {
        ...
        public Real GetRealWorldHeight( Real x, Real z, TileInfo info )
        {
            // figure out which page the point is on
        ...
        public Real GetRealPageHeight( Real x, Real z, long pageX, long pageZ, long Lod )
        {
            // scale position from world to page scale
            Real localX = x / Options.Instance.Scale.x;
            Real localZ = z / Options.Instance.Scale.z;

            // adjust x and z to be local to page
            long pSize = Options.Instance.PageSize - 1;
            localX -= (Real)( pageX - Options.Instance.World_Width * 0.5f ) * pSize;
            localZ -= (Real)( pageZ - Options.Instance.World_Height * 0.5f ) * pSize;
            ...
            Real bottom_left_y = data.GetHeight( bottom_left_x, bottom_left_z );
            Real bottom_right_y = data.GetHeight( bottom_left_x + vertex_spread, bottom_left_z );
            Real top_left_y = data.GetHeight( bottom_left_x, bottom_left_z + vertex_spread );
            Real top_right_y = data.GetHeight( bottom_left_x + vertex_spread, bottom_left_z + vertex_spread );

            Real x_pct = ( localX - (Real)bottom_left_x ) / (Real)vertex_spread;
            Real z_pct = ( localZ - (Real)bottom_left_z ) / (Real)vertex_spread;
        ...
        public ColorEx GetCoverageAt( long dataX, long dataZ, Real x, Real z )
        {
            Data2D data = data2D[ dataX ][ dataZ ];
            if ( data.IsLoaded )
            {
        ...
        public ColorEx GetBaseAt( long dataX, long dataZ, Real x, Real z )
        {
            Data2D data = data2D[ dataX ][ dataZ ];
            if ( data.IsLoaded )
            {
        ...
        public Vector3 GetNormalAt( long dataX, long dataZ, Real x, Real z )
        {
            Data2D data = data2D[ dataX ][ dataZ ];
            if ( data.IsLoaded )
            {
