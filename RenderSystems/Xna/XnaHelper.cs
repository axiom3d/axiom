...
namespace Axiom.RenderSystems.Xna
{
    ...
    public class D3DHelper
    {
        ...
        public static DriverCollection GetDriverInfo()
        {
            ...
            foreach ( D3D.Graphics.GraphicsAdapter adapterDetails in D3D.Graphics.GraphicsAdapter.Adapters )
            {
                ...
                D3D.Graphics.SurfaceFormat lastFormat = 0;

                foreach ( D3D.Graphics.DisplayMode mode in adapterDetails.SupportedDisplayModes )
                {
                ...
                case FilterType.Min:
                    {
                        switch ( options )
                        {
                            case FilterOptions.Anisotropic:
                                ...
                                {
                                    return D3D.Graphics.TextureFilter.Anisotropic;
                                }
                                else
                                {
                                    return D3D.Graphics.TextureFilter.Linear;
                                }
                            ...
                            case FilterOptions.Linear:
                                ...
                                {
                                    return D3D.Graphics.TextureFilter.Point;
                                }
                ...
                case FilterType.Mip:
                    {
                        switch ( options )
                        {
                            ...
                            case FilterOptions.Point:
                                ...
                                {
                                    return D3D.Graphics.TextureFilter.None;
                                }
        ...
        public static D3D.Graphics.TextureArgument ConvertEnum( LayerBlendSource blendSource )
        {
            D3D.Graphics.TextureArgument d3dTexArg = 0;

            switch ( blendSource )
            {
                case LayerBlendSource.Current:
                    d3dTexArg = D3D.Graphics.TextureArgument.Current;
                    break;

                case LayerBlendSource.Texture:
                    d3dTexArg = D3D.Graphics.TextureArgument.Texture2D;
                    break;

                case LayerBlendSource.Diffuse:
                    d3dTexArg = D3D.Graphics.TextureArgument.Diffuse;
                    break;

                case LayerBlendSource.Specular:
                    d3dTexArg = D3D.Graphics.TextureArgument.Specular;
                    break;

                case LayerBlendSource.Manual:
                    d3dTexArg = D3D.Graphics.TextureArgument.TextureFactor;
                    break;
            } // end switch
        ...
        /// <returns></returns>
        public static D3D.Graphics.Blend ConvertEnum( SceneBlendFactor factor )
        {
            D3D.Graphics.Blend d3dBlend = 0;

            switch ( factor )
            {
                case SceneBlendFactor.One:
                    d3dBlend = D3D.Graphics.Blend.One;
                    break;
                case SceneBlendFactor.Zero:
                    d3dBlend = D3D.Graphics.Blend.Zero;
                    break;
                case SceneBlendFactor.DestColor:
                    d3dBlend = D3D.Graphics.Blend.DestinationColor;
                    break;
                case SceneBlendFactor.SourceColor:
                    d3dBlend = D3D.Graphics.Blend.SourceColor;
                    break;
                case SceneBlendFactor.OneMinusDestColor:
                    d3dBlend = D3D.Graphics.Blend.InverseDestinationColor;
                    break;
                case SceneBlendFactor.OneMinusSourceColor:
                    d3dBlend = D3D.Graphics.Blend.InverseSourceColor;
                    break;
                case SceneBlendFactor.DestAlpha:
                    d3dBlend = D3D.Graphics.Blend.DestinationAlpha;
                    break;
                case SceneBlendFactor.SourceAlpha:
                    d3dBlend = D3D.Graphics.Blend.SourceAlpha;
                    break;
                case SceneBlendFactor.OneMinusDestAlpha:
                    d3dBlend = D3D.Graphics.Blend.InverseDestinationAlpha;
                    break;
                case SceneBlendFactor.OneMinusSourceAlpha:
                    d3dBlend = D3D.Graphics.Blend.InverseSourceAlpha;
                    break;
            }
        ...
        public static D3D.Graphics.VertexElementFormat ConvertEnum( VertexElementType type )
        {
            // we only need to worry about a few types with D3D
            switch ( type )
            {
                case VertexElementType.Color:
                    return D3D.Graphics.VertexElementFormat.Color;

                case VertexElementType.Float1:
                    return D3D.Graphics.VertexElementFormat.Single;

                case VertexElementType.Float2:
                    return D3D.Graphics.VertexElementFormat.Vector2;

                case VertexElementType.Float3:
                    return D3D.Graphics.VertexElementFormat.Vector3;

                case VertexElementType.Float4:
                    return D3D.Graphics.VertexElementFormat.Vector4;

                case VertexElementType.Short2:
                    return D3D.Graphics.VertexElementFormat.Short2;

                case VertexElementType.Short4:
                    return D3D.Graphics.VertexElementFormat.Short4;

                case VertexElementType.UByte4:
                    return D3D.Graphics.VertexElementFormat.Byte4;
        ...
        public static D3D.Graphics.VertexElementUsage ConvertEnum( VertexElementSemantic semantic )
        {
            switch ( semantic )
            {
                case VertexElementSemantic.BlendIndices:
                    return D3D.Graphics.VertexElementUsage.BlendIndices;

                case VertexElementSemantic.BlendWeights:
                    return D3D.Graphics.VertexElementUsage.BlendWeight;

                case VertexElementSemantic.Diffuse:
                    // index makes the difference (diffuse - 0)
                    return D3D.Graphics.VertexElementUsage.Color;
                ...
                case VertexElementSemantic.Normal:
                    return D3D.Graphics.VertexElementUsage.Normal;

                case VertexElementSemantic.Position:
                    return D3D.Graphics.VertexElementUsage.Position;

                case VertexElementSemantic.TexCoords:
                    return D3D.Graphics.VertexElementUsage.TextureCoordinate;

                case VertexElementSemantic.Binormal:
                    return D3D.Graphics.VertexElementUsage.Binormal;

                case VertexElementSemantic.Tangent:
                    return D3D.Graphics.VertexElementUsage.Tangent;
            } // switch
        ...
        public static D3D.Graphics.ResourceUsage ConvertEnum( BufferUsage usage )
        {
            D3D.Graphics.ResourceUsage d3dUsage = 0;

            if ( usage == BufferUsage.Dynamic ||
                 usage == BufferUsage.DynamicWriteOnly )
            {
                d3dUsage |= D3D.Graphics.ResourceUsage.Dynamic;
            }
            ...
            if ( usage == BufferUsage.WriteOnly ||
                 ...
                 usage == BufferUsage.DynamicWriteOnly )
            {
                d3dUsage |= D3D.Graphics.ResourceUsage.WriteOnly;
            }
        ...
        /// <returns></returns>
        public static D3D.Graphics.FogMode ConvertEnum( Axiom.Graphics.FogMode mode )
        {
            // convert the fog mode value
            switch ( mode )
            {
                case Axiom.Graphics.FogMode.Exp:
                    return D3D.Graphics.FogMode.Exponent;

                case Axiom.Graphics.FogMode.Exp2:
                    return D3D.Graphics.FogMode.ExponentSquared;

                case Axiom.Graphics.FogMode.Linear:
                    return D3D.Graphics.FogMode.Linear;
            } // switch
        ...
        /// <returns></returns>
        public static int ConvertEnum( TexCoordCalcMethod method, D3D.Graphics.GraphicsDeviceCapabilities caps )
        {
            //switch ( method )
            //{
            //    case TexCoordCalcMethod.None:
            //        return (int)D3D.Graphics.TextureCoordinateIndex.PassThrough;
        ...
        public static D3D.Graphics.TextureAddressMode ConvertEnum( TextureAddressing type )
        {
            ...
            switch ( type )
            {
                case TextureAddressing.Wrap:
                    return D3D.Graphics.TextureAddressMode.Wrap;

                case TextureAddressing.Mirror:
                    return D3D.Graphics.TextureAddressMode.Mirror;

                case TextureAddressing.Clamp:
                    return D3D.Graphics.TextureAddressMode.Clamp;
            } // end switch
        ...
        /// <returns></returns>
        public static D3D.Graphics.CompareFunction ConvertEnum( CompareFunction func )
        {
            switch ( func )
            {
                case CompareFunction.AlwaysFail:
                    return D3D.Graphics.CompareFunction.Never;

                case CompareFunction.AlwaysPass:
                    return D3D.Graphics.CompareFunction.Always;

                case CompareFunction.Equal:
                    return D3D.Graphics.CompareFunction.Equal;

                case CompareFunction.Greater:
                    return D3D.Graphics.CompareFunction.Greater;

                case CompareFunction.GreaterEqual:
                    return D3D.Graphics.CompareFunction.GreaterEqual;

                case CompareFunction.Less:
                    return D3D.Graphics.CompareFunction.Less;

                case CompareFunction.LessEqual:
                    return D3D.Graphics.CompareFunction.LessEqual;

                case CompareFunction.NotEqual:
                    return D3D.Graphics.CompareFunction.NotEqual;
            }
        ...
        public static D3D.Graphics.StencilOperation ConvertEnum( Axiom.Graphics.StencilOperation op )
        {
        ...
        /// <param name="op"></param>
        /// <returns></returns>
        public static D3D.Graphics.StencilOperation ConvertEnum( Axiom.Graphics.StencilOperation op, bool invert )
        {
            switch ( op )
            {
                case Axiom.Graphics.StencilOperation.Keep:
                    return D3D.Graphics.StencilOperation.Keep;

                case Axiom.Graphics.StencilOperation.Zero:
                    return D3D.Graphics.StencilOperation.Zero;

                case Axiom.Graphics.StencilOperation.Replace:
                    return D3D.Graphics.StencilOperation.Replace;

                case Axiom.Graphics.StencilOperation.Increment:
                    return invert ?
                        D3D.Graphics.StencilOperation.DecrementSaturation : D3D.Graphics.StencilOperation.IncrementSaturation;

                case Axiom.Graphics.StencilOperation.Decrement:
                    return invert ?
                        D3D.Graphics.StencilOperation.IncrementSaturation : D3D.Graphics.StencilOperation.DecrementSaturation;

                case Axiom.Graphics.StencilOperation.IncrementWrap:
                    return invert ?
                        D3D.Graphics.StencilOperation.Decrement : D3D.Graphics.StencilOperation.Increment;

                case Axiom.Graphics.StencilOperation.DecrementWrap:
                    return invert ?
                        D3D.Graphics.StencilOperation.Increment : D3D.Graphics.StencilOperation.Decrement;

                case Axiom.Graphics.StencilOperation.Invert:
                    return D3D.Graphics.StencilOperation.Invert;
            }

            return 0;
        }

        public static D3D.Graphics.CullMode ConvertEnum( Axiom.Graphics.CullingMode mode, bool flip )
        {
            switch ( mode )
            {
                case CullingMode.None:
                    return D3D.Graphics.CullMode.None;

                case CullingMode.Clockwise:
                    return flip ? D3D.Graphics.CullMode.CullCounterClockwiseFace : D3D.Graphics.CullMode.CullClockwiseFace;

                case CullingMode.CounterClockwise:
                    return flip ? D3D.Graphics.CullMode.CullClockwiseFace : D3D.Graphics.CullMode.CullCounterClockwiseFace;
            }
