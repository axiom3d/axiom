...
namespace Axiom.RenderSystems.Xna
{
    ...
    public class VideoMode
    {
        ...
        private D3D.Graphics.DisplayMode displayMode;
        private int modeNum;
        ...
        {
            modeNum = ++modeCount;
            displayMode = new D3D.Graphics.DisplayMode();
        }
        ...
        /// </summary>
        public VideoMode( D3D.Graphics.DisplayMode videoMode )
        {
            modeNum = ++modeCount;
        ...
        /// </summary>
        public D3D.Graphics.SurfaceFormat Format
        {
            get
            {
        ...
        public int ColorDepth
        {
            get
            {
                if ( displayMode.Format == D3D.Graphics.SurfaceFormat.Bgr32 ||
                    displayMode.Format == D3D.Graphics.SurfaceFormat.Color ||
                    displayMode.Format == D3D.Graphics.SurfaceFormat.Bgr24 )
                {
                    return 32;
                }
                else
        ...
        /// </summary>
        public D3D.Graphics.DisplayMode DisplayMode
        {
            get
            {
                return displayMode;
