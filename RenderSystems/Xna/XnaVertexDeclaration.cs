...
namespace Axiom.RenderSystems.XNA
{
    ...
    public class XNAVertexDeclaration : VertexDeclaration
    {
        ...
        protected D3D.Graphics.VertexDeclaration d3dVertexDecl;
        ...
        /// </summary>
        /// DOC
        public D3D.Graphics.VertexDeclaration D3DVertexDecl
        {
            get
            {
                ...
                if ( needsRebuild )
                {
                    ...
                    D3D.Graphics.VertexElement[] d3dElements = new D3D.Graphics.VertexElement[elements.Count + 1];
                    ...
                    //d3dElements[elements.Count] = D3D.Graphics.VertexElement.VertexDeclarationEnd;

                    // create the new declaration
                    d3dVertexDecl = new D3D.Graphics.VertexDeclaration( device, d3dElements );
