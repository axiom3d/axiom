...
namespace Axiom.RenderSystems.Xna.HLSL
{
    ...
    public class HLSLProgram : HighLevelGpuProgram
    {
        ...
        /// </summary>
        protected DX.Graphics.CompiledShader microcode;
        /// <summary>
        ///     Holds information about shader constants.
        /// </summary>
        protected D3D.Graphics.ShaderConstantTable constantTable;
        ...
        protected override void CreateLowLevelImpl()
        {
            ...
            assemblerProgram = GpuProgramManager.Instance.CreateProgramFromString( name, "", type, target );
        ...
        protected override void LoadFromSource()
        {
            ...
            microcode = D3D.Graphics.ShaderCompiler.AssembleFromSource( source,  null, null,  D3D.Graphics.CompilerOptions.PackMatrixRowMajor);
        ...
        /// <param name="parms"></param>
        protected void ProcessParamElement( D3D.Graphics.Effect parent, string prefix, int index, GpuProgramParameters parms )
        {
            D3D.Graphics.ShaderConstant constant = constantTable.Constants[ index ];
            ...
            {
                if ( desc.Class == D3D.Graphics.ParameterClass.Struct )
                {
                ...
                {
                    // process params
                    if ( desc.ParameterType == D3D.Graphics.ParameterType.Float ||
