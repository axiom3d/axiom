	...
	public class D3D9RenderSystem : RenderSystem {
		...
		public override SceneDetailLevel RasterizationMode {
			get {
				...
				{
					case FillMode.Point: return SceneDetailLevel.Points;
					case FillMode.WireFrame: return SceneDetailLevel.Wireframe;
					case FillMode.Solid: return SceneDetailLevel.Solid;
