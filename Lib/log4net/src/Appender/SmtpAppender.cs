...
namespace log4net.Appender
{
	...
	public class SmtpAppender : BufferingAppenderSkeleton
	{
		...
		/// </summary>
		/// <value>
		/// One of the <see cref="System.Net.Mail.MailPriority"/> values.
		/// </value>
		/// <remarks>
		/// <para>
		/// Sets the priority of the e-mails generated by this
		/// appender. The default priority is <see cref="System.Net.Mail.MailPriority.Normal"/>.
		/// </para>
		/// <para>
		/// If you are using this appender to report errors then
		/// you may want to set the priority to <see cref="System.Net.Mail.MailPriority.High"/>.
		/// </para>
		/// </remarks>
		...
		virtual protected void SendEmail(string messageBody)
		{
			...
			smtpClient.Send(mailMessage);
                ...
                MailMessage mailMessage = new MailMessage(m_from, m_to);
				mailMessage.Body = messageBody;
				mailMessage.Subject = m_subject;
